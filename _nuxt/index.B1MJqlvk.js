...
`:">",i};Mu.prototype.renderInline=function(u,e,t){let n="";const r=this.rules;for(let i=0,o=u.length;i<o;i++){const c=u[i].type;typeof r[c]<"u"?n+=r[c](u,i,e,t,this):n+=this.renderToken(u,i,e)}return n};Mu.prototype.renderInlineAsText=function(u,e,t){let n="";for(let r=0,i=u.length;r<i;r++)switch(u[r].type){case"text":n+=u[r].content;break;case"image":n+=this.renderInlineAsText(u[r].children,e,t);break;case"html_inline":case"html_block":n+=u[r].content;break;case"softbreak":case"hardbreak":n+=`
`;break}return n};Mu.prototype.render=function(u,e,t){let n="";const r=this.rules;for(let i=0,o=u.length;i<o;i++){const c=u[i].type;c==="inline"?n+=this.renderInline(u[i].children,e,t):typeof r[c]<"u"?n+=r[c](u,i,e,t,this):n+=this.renderToken(u,i,e,t)}return n};function eu(){this.__rules__=[],this.__cache__=null}eu.prototype.__find__=function(u){for(let e=0;e<this.__rules__.length;e++)if(this.__rules__[e].name===u)return e;return-1};eu.prototype.__compile__=function(){const u=this,e=[""];u.__rules__.forEach(function(t){t.enabled&&t.alt.forEach(function(n){e.indexOf(n)<0&&e.push(n)})}),u.__cache__={},e.forEach(function(t){u.__cache__[t]=[],u.__rules__.forEach(function(n){n.enabled&&(t&&n.alt.indexOf(t)<0||u.__cache__[t].push(n.fn))})})};eu.prototype.at=function(u,e,t){const n=this.__find__(u),r=t||{};if(n===-1)throw new Error("Parser rule not found: "+u);this.__rules__[n].fn=e,this.__rules__[n].alt=r.alt||[],this.__cache__=null};eu.prototype.before=function(u,e,t,n){const r=this.__find__(u),i=n||{};if(r===-1)throw new Error("Parser rule not found: "+u);this.__rules__.splice(r,0,{name:e,enabled:!0,fn:t,alt:i.alt||[]}),this.__cache__=null};eu.prototype.after=function(u,e,t,n){const r=this.__find__(u),i=n||{};if(r===-1)throw new Error("Parser rule not found: "+u);this.__rules__.splice(r+1,0,{name:e,enabled:!0,fn:t,alt:i.alt||[]}),this.__cache__=null};eu.prototype.push=function(u,e,t){const n=t||{};this.__rules__.push({name:u,enabled:!0,fn:e,alt:n.alt||[]}),this.__cache__=null};eu.prototype.enable=function(u,e){Array.isArray(u)||(u=[u]);const t=[];return u.forEach(function(n){const r=this.__find__(n);if(r<0){if(e)return;throw new Error("Rules manager: invalid rule name "+n)}this.__rules__[r].enabled=!0,t.push(n)},this),this.__cache__=null,t};eu.prototype.enableOnly=function(u,e){Array.isArray(u)||(u=[u]),this.__rules__.forEach(function(t){t.enabled=!1}),this.enable(u,e)};eu.prototype.disable=function(u,e){Array.isArray(u)||(u=[u]);const t=[];return u.forEach(function(n){const r=this.__find__(n);if(r<0){if(e)return;throw new Error("Rules manager: invalid rule name "+n)}this.__rules__[r].enabled=!1,t.push(n)},this),this.__cache__=null,t};eu.prototype.getRules=function(u){return this.__cache__===null&&this.__compile__(),this.__cache__[u]||[]};function cu(u,e,t){this.type=u,this.tag=e,this.attrs=null,this.map=null,this.nesting=t,this.level=0,this.children=null,this.content="",this.markup="",this.info="",this.meta=null,this.block=!1,this.hidden=!1}cu.prototype.attrIndex=function(e){if(!this.attrs)return-1;const t=this.attrs;for(let n=0,r=t.length;n<r;n++)if(t[n][0]===e)return n;return-1};cu.prototype.attrPush=function(e){this.attrs?this.attrs.push(e):this.attrs=[e]};cu.prototype.attrSet=function(e,t){const n=this.attrIndex(e),r=[e,t];n<0?this.attrPush(r):this.attrs[n]=r};cu.prototype.attrGet=function(e){const t=this.attrIndex(e);let n=null;return t>=0&&(n=this.attrs[t][1]),n};cu.prototype.attrJoin=function(e,t){const n=this.attrIndex(e);n<0?this.attrPush([e,t]):this.attrs[n][1]=this.attrs[n][1]+" "+t};function ln(u,e,t){this.src=u,this.env=t,this.tokens=[],this.inlineMode=!1,this.md=e}ln.prototype.Token=cu;const P0=/\r\n?|\n/g,M0=/\0/g;function z0(u){let e;e=u.src.replace(P0,`
`),e=e.replace(M0,"�"),u.src=e}function $0(u){let e;u.inlineMode?(e=new u.Token("inline","",0),e.content=u.src,e.map=[0,1],e.children=[],u.tokens.push(e)):u.md.block.parse(u.src,u.md,u.env,u.tokens)}function q0(u){const e=u.tokens;for(let t=0,n=e.length;t<n;t++){const r=e[t];r.type==="inline"&&u.md.inline.parse(r.content,u.md,u.env,r.children)}}function j0(u){return/^<a[>\s]/i.test(u)}function U0(u){return/^<\/a\s*>/i.test(u)}function H0(u){const e=u.tokens;if(u.md.options.linkify)for(let t=0,n=e.length;t<n;t++){if(e[t].type!=="inline"||!u.md.linkify.pretest(e[t].content))continue;let r=e[t].children,i=0;for(let o=r.length-1;o>=0;o--){const c=r[o];if(c.type==="link_close"){for(o--;r[o].level!==c.level&&r[o].type!=="link_open";)o--;continue}if(c.type==="html_inline"&&(j0(c.content)&&i>0&&i--,U0(c.content)&&i++),!(i>0)&&c.type==="text"&&u.md.linkify.test(c.content)){const s=c.content;let a=u.md.linkify.match(s);const d=[];let l=c.level,x=0;a.length>0&&a[0].index===0&&o>0&&r[o-1].type==="text_special"&&(a=a.slice(1));for(let _=0;_<a.length;_++){const h=a[_].url,w=u.md.normalizeLink(h);if(!u.md.validateLink(w))continue;let R=a[_].text;a[_].schema?a[_].schema==="mailto:"&&!/^mailto:/i.test(R)?R=u.md.normalizeLinkText("mailto:"+R).replace(/^mailto:/,""):R=u.md.normalizeLinkText(R):R=u.md.normalizeLinkText("http://"+R).replace(/^http:\/\//,"");const B=a[_].index;if(B>x){const v=new u.Token("text","",0);v.content=s.slice(x,B),v.level=l,d.push(v)}const O=new u.Token("link_open","a",1);O.attrs=[["href",w]],O.level=l++,O.markup="linkify",O.info="auto",d.push(O);const F=new u.Token("text","",0);F.content=R,F.level=l,d.push(F);const T=new u.Token("link_close","a",-1);T.level=--l,T.markup="linkify",T.info="auto",d.push(T),x=a[_].lastIndex}if(x<s.length){const _=new u.Token("text","",0);_.content=s.slice(x),_.level=l,d.push(_)}e[t].children=r=sn(r,o,d)}}}}const fn=/\+-|\.\.|\?\?\?\?|!!!!|,,|--/,G0=/\((c|tm|r)\)/i,V0=/\((c|tm|r)\)/ig,W0={c:"©",r:"®",tm:"™"};function Z0(u,e){return W0[e.toLowerCase()]}function J0(u){let e=0;for(let t=u.length-1;t>=0;t--){const n=u[t];n.type==="text"&&!e&&(n.content=n.content.replace(V0,Z0)),n.type==="link_open"&&n.info==="auto"&&e--,n.type==="link_close"&&n.info==="auto"&&e++}}function K0(u){let e=0;for(let t=u.length-1;t>=0;t--){const n=u[t];n.type==="text"&&!e&&fn.test(n.content)&&(n.content=n.content.replace(/\+-/g,"±").replace(/\.{2,}/g,"…").replace(/([?!])…/g,"$1..").replace(/([?!]){4,}/g,"$1$1$1").replace(/,{2,}/g,",").replace(/(^|[^-])---(?=[^-]|$)/mg,"$1—").replace(/(^|\s)--(?=\s|$)/mg,"$1–").replace(/(^|[^-\s])--(?=[^-\s]|$)/mg,"$1–")),n.type==="link_open"&&n.info==="auto"&&e--,n.type==="link_close"&&n.info==="auto"&&e++}}function X0(u){let e;if(u.md.options.typographer)for(e=u.tokens.length-1;e>=0;e--)u.tokens[e].type==="inline"&&(G0.test(u.tokens[e].content)&&J0(u.tokens[e].children),fn.test(u.tokens[e].content)&&K0(u.tokens[e].children))}const Q0=/['"]/,yt=/['"]/g,kt="’";function te(u,e,t){return u.slice(0,e)+t+u.slice(e+1)}function Y0(u,e){let t;const n=[];for(let r=0;r<u.length;r++){const i=u[r],o=u[r].level;for(t=n.length-1;t>=0&&!(n[t].level<=o);t--);if(n.length=t+1,i.type!=="text")continue;let c=i.content,s=0,a=c.length;u:for(;s<a;){yt.lastIndex=s;const d=yt.exec(c);if(!d)break;let l=!0,x=!0;s=d.index+1;const _=d[0]==="'";let h=32;if(d.index-1>=0)h=c.charCodeAt(d.index-1);else for(t=r-1;t>=0&&!(u[t].type==="softbreak"||u[t].type==="hardbreak");t--)if(u[t].content){h=u[t].content.charCodeAt(u[t].content.length-1);break}let w=32;if(s<a)w=c.charCodeAt(s);else for(t=r+1;t<u.length&&!(u[t].type==="softbreak"||u[t].type==="hardbreak");t++)if(u[t].content){w=u[t].content.charCodeAt(0);break}const R=Vu(h)||Gu(String.fromCharCode(h)),B=Vu(w)||Gu(String.fromCharCode(w)),O=Hu(h),F=Hu(w);if(F?l=!1:B&&(O||R||(l=!1)),O?x=!1:R&&(F||B||(x=!1)),w===34&&d[0]==='"'&&h>=48&&h<=57&&(x=l=!1),l&&x&&(l=R,x=B),!l&&!x){_&&(i.content=te(i.content,d.index,kt));continue}if(x)for(t=n.length-1;t>=0;t--){let T=n[t];if(n[t].level<o)break;if(T.single===_&&n[t].level===o){T=n[t];let v,M;_?(v=e.md.options.quotes[2],M=e.md.options.quotes[3]):(v=e.md.options.quotes[0],M=e.md.options.quotes[1]),i.content=te(i.content,d.index,M),u[T.token].content=te(u[T.token].content,T.pos,v),s+=M.length-1,T.token===r&&(s+=v.length-1),c=i.content,a=c.length,n.length=t;continue u}}l?n.push({token:r,pos:d.index,single:_,level:o}):x&&_&&(i.content=te(i.content,d.index,kt))}}}function ui(u){if(u.md.options.typographer)for(let e=u.tokens.length-1;e>=0;e--)u.tokens[e].type!=="inline"||!Q0.test(u.tokens[e].content)||Y0(u.tokens[e].children,u)}function ei(u){let e,t;const n=u.tokens,r=n.length;for(let i=0;i<r;i++){if(n[i].type!=="inline")continue;const o=n[i].children,c=o.length;for(e=0;e<c;e++)o[e].type==="text_special"&&(o[e].type="text");for(e=t=0;e<c;e++)o[e].type==="text"&&e+1<c&&o[e+1].type==="text"?o[e+1].content=o[e].content+o[e+1].content:(e!==t&&(o[t]=o[e]),t++);e!==t&&(o.length=t)}}const we=[["normalize",z0],["block",$0],["inline",q0],["linkify",H0],["replacements",X0],["smartquotes",ui],["text_join",ei]];function Ke(){this.ruler=new eu;for(let u=0;u<we.length;u++)this.ruler.push(we[u][0],we[u][1])}Ke.prototype.process=function(u){const e=this.ruler.getRules("");for(let t=0,n=e.length;t<n;t++)e[t](u)};Ke.prototype.State=ln;function _u(u,e,t,n){this.src=u,this.md=e,this.env=t,this.tokens=n,this.bMarks=[],this.eMarks=[],this.tShift=[],this.sCount=[],this.bsCount=[],this.blkIndent=0,this.line=0,this.lineMax=0,this.tight=!1,this.ddIndent=-1,this.listIndent=-1,this.parentType="root",this.level=0;const r=this.src;for(let i=0,o=0,c=0,s=0,a=r.length,d=!1;o<a;o++){const l=r.charCodeAt(o);if(!d)if(U(l)){c++,l===9?s+=4-s%4:s++;continue}else d=!0;(l===10||o===a-1)&&(l!==10&&o++,this.bMarks.push(i),this.eMarks.push(o),this.tShift.push(c),this.sCount.push(s),this.bsCount.push(0),d=!1,c=0,s=0,i=o+1)}this.bMarks.push(r.length),this.eMarks.push(r.length),this.tShift.push(0),this.sCount.push(0),this.bsCount.push(0),this.lineMax=this.bMarks.length-1}_u.prototype.push=function(u,e,t){const n=new cu(u,e,t);return n.block=!0,t<0&&this.level--,n.level=this.level,t>0&&this.level++,this.tokens.push(n),n};_u.prototype.isEmpty=function(e){return this.bMarks[e]+this.tShift[e]>=this.eMarks[e]};_u.prototype.skipEmptyLines=function(e){for(let t=this.lineMax;e<t&&!(this.bMarks[e]+this.tShift[e]<this.eMarks[e]);e++);return e};_u.prototype.skipSpaces=function(e){for(let t=this.src.length;e<t;e++){const n=this.src.charCodeAt(e);if(!U(n))break}return e};_u.prototype.skipSpacesBack=function(e,t){if(e<=t)return e;for(;e>t;)if(!U(this.src.charCodeAt(--e)))return e+1;return e};_u.prototype.skipChars=function(e,t){for(let n=this.src.length;e<n&&this.src.charCodeAt(e)===t;e++);return e};_u.prototype.skipCharsBack=function(e,t,n){if(e<=n)return e;for(;e>n;)if(t!==this.src.charCodeAt(--e))return e+1;return e};_u.prototype.getLines=function(e,t,n,r){if(e>=t)return"";const i=new Array(t-e);for(let o=0,c=e;c<t;c++,o++){let s=0;const a=this.bMarks[c];let d=a,l;for(c+1<t||r?l=this.eMarks[c]+1:l=this.eMarks[c];d<l&&s<n;){const x=this.src.charCodeAt(d);if(U(x))x===9?s+=4-(s+this.bsCount[c])%4:s++;else if(d-a<this.tShift[c])s++;else break;d++}s>n?i[o]=new Array(s-n+1).join(" ")+this.src.slice(d,l):i[o]=this.src.slice(d,l)}return i.join("")};_u.prototype.Token=cu;function Ce(u,e){const t=u.bMarks[e]+u.tShift[e],n=u.eMarks[e];return u.src.slice(t,n)}function Et(u){const e=[],t=u.length;let n=0,r=u.charCodeAt(n),i=!1,o=0,c="";for(;n<t;)r===124&&(i?(c+=u.substring(o,n-1),o=n):(e.push(c+u.substring(o,n)),c="",o=n+1)),i=r===92,n++,r=u.charCodeAt(n);return e.push(c+u.substring(o)),e}function ti(u,e,t,n){if(e+2>t)return!1;let r=e+1;if(u.sCount[r]<u.blkIndent||u.sCount[r]-u.blkIndent>=4)return!1;let i=u.bMarks[r]+u.tShift[r];if(i>=u.eMarks[r])return!1;const o=u.src.charCodeAt(i++);if(o!==124&&o!==45&&o!==58||i>=u.eMarks[r])return!1;const c=u.src.charCodeAt(i++);if(c!==124&&c!==45&&c!==58&&!U(c)||o===45&&U(c))return!1;for(;i<u.eMarks[r];){const F=u.src.charCodeAt(i);if(F!==124&&F!==45&&F!==58&&!U(F))return!1;i++}let s=Ce(u,e+1),a=s.split("|");const d=[];for(let F=0;F<a.length;F++){const T=a[F].trim();if(!T){if(F===0||F===a.length-1)continue;return!1}if(!/^:?-+:?$/.test(T))return!1;T.charCodeAt(T.length-1)===58?d.push(T.charCodeAt(0)===58?"center":"right"):T.charCodeAt(0)===58?d.push("left"):d.push("")}if(s=Ce(u,e).trim(),s.indexOf("|")===-1||u.sCount[e]-u.blkIndent>=4)return!1;a=Et(s),a.length&&a[0]===""&&a.shift(),a.length&&a[a.length-1]===""&&a.pop();const l=a.length;if(l===0||l!==d.length)return!1;if(n)return!0;const x=u.parentType;u.parentType="table";const _=u.md.block.ruler.getRules("blockquote"),h=u.push("table_open","table",1),w=[e,0];h.map=w;const R=u.push("thead_open","thead",1);R.map=[e,e+1];const B=u.push("tr_open","tr",1);B.map=[e,e+1];for(let F=0;F<a.length;F++){const T=u.push("th_open","th",1);d[F]&&(T.attrs=[["style","text-align:"+d[F]]]);const v=u.push("inline","",0);v.content=a[F].trim(),v.children=[],u.push("th_close","th",-1)}u.push("tr_close","tr",-1),u.push("thead_close","thead",-1);let O;for(r=e+2;r<t&&!(u.sCount[r]<u.blkIndent);r++){let F=!1;for(let v=0,M=_.length;v<M;v++)if(_[v](u,r,t,!0)){F=!0;break}if(F||(s=Ce(u,r).trim(),!s)||u.sCount[r]-u.blkIndent>=4)break;if(a=Et(s),a.length&&a[0]===""&&a.shift(),a.length&&a[a.length-1]===""&&a.pop(),r===e+2){const v=u.push("tbody_open","tbody",1);v.map=O=[e+2,0]}const T=u.push("tr_open","tr",1);T.map=[r,r+1];for(let v=0;v<l;v++){const M=u.push("td_open","td",1);d[v]&&(M.attrs=[["style","text-align:"+d[v]]]);const V=u.push("inline","",0);V.content=a[v]?a[v].trim():"",V.children=[],u.push("td_close","td",-1)}u.push("tr_close","tr",-1)}return O&&(u.push("tbody_close","tbody",-1),O[1]=r),u.push("table_close","table",-1),w[1]=r,u.parentType=x,u.line=r,!0}function ni(u,e,t){if(u.sCount[e]-u.blkIndent<4)return!1;let n=e+1,r=n;for(;n<t;){if(u.isEmpty(n)){n++;continue}if(u.sCount[n]-u.blkIndent>=4){n++,r=n;continue}break}u.line=r;const i=u.push("code_block","code",0);return i.content=u.getLines(e,r,4+u.blkIndent,!1)+`
`,i.map=[e,u.line],!0}function ri(u,e,t,n){let r=u.bMarks[e]+u.tShift[e],i=u.eMarks[e];if(u.sCount[e]-u.blkIndent>=4||r+3>i)return!1;const o=u.src.charCodeAt(r);if(o!==126&&o!==96)return!1;let c=r;r=u.skipChars(r,o);let s=r-c;if(s<3)return!1;const a=u.src.slice(c,r),d=u.src.slice(r,i);if(o===96&&d.indexOf(String.fromCharCode(o))>=0)return!1;if(n)return!0;let l=e,x=!1;for(;l++,!(l>=t||(r=c=u.bMarks[l]+u.tShift[l],i=u.eMarks[l],r<i&&u.sCount[l]<u.blkIndent));)if(u.src.charCodeAt(r)===o&&!(u.sCount[l]-u.blkIndent>=4)&&(r=u.skipChars(r,o),!(r-c<s)&&(r=u.skipSpaces(r),!(r<i)))){x=!0;break}s=u.sCount[e],u.line=l+(x?1:0);const _=u.push("fence","code",0);return _.info=d,_.content=u.getLines(e+1,l,s,!0),_.markup=a,_.map=[e,u.line],!0}function ii(u,e,t,n){let r=u.bMarks[e]+u.tShift[e],i=u.eMarks[e];const o=u.lineMax;if(u.sCount[e]-u.blkIndent>=4||u.src.charCodeAt(r)!==62)return!1;if(n)return!0;const c=[],s=[],a=[],d=[],l=u.md.block.ruler.getRules("blockquote"),x=u.parentType;u.parentType="blockquote";let _=!1,h;for(h=e;h<t;h++){const F=u.sCount[h]<u.blkIndent;if(r=u.bMarks[h]+u.tShift[h],i=u.eMarks[h],r>=i)break;if(u.src.charCodeAt(r++)===62&&!F){let v=u.sCount[h]+1,M,V;u.src.charCodeAt(r)===32?(r++,v++,V=!1,M=!0):u.src.charCodeAt(r)===9?(M=!0,(u.bsCount[h]+v)%4===3?(r++,v++,V=!1):V=!0):M=!1;let su=v;for(c.push(u.bMarks[h]),u.bMarks[h]=r;r<i;){const au=u.src.charCodeAt(r);if(U(au))au===9?su+=4-(su+u.bsCount[h]+(V?1:0))%4:su++;else break;r++}_=r>=i,s.push(u.bsCount[h]),u.bsCount[h]=u.sCount[h]+1+(M?1:0),a.push(u.sCount[h]),u.sCount[h]=su-v,d.push(u.tShift[h]),u.tShift[h]=r-u.bMarks[h];continue}if(_)break;let T=!1;for(let v=0,M=l.length;v<M;v++)if(l[v](u,h,t,!0)){T=!0;break}if(T){u.lineMax=h,u.blkIndent!==0&&(c.push(u.bMarks[h]),s.push(u.bsCount[h]),d.push(u.tShift[h]),a.push(u.sCount[h]),u.sCount[h]-=u.blkIndent);break}c.push(u.bMarks[h]),s.push(u.bsCount[h]),d.push(u.tShift[h]),a.push(u.sCount[h]),u.sCount[h]=-1}const w=u.blkIndent;u.blkIndent=0;const R=u.push("blockquote_open","blockquote",1);R.markup=">";const B=[e,0];R.map=B,u.md.block.tokenize(u,e,h);const O=u.push("blockquote_close","blockquote",-1);O.markup=">",u.lineMax=o,u.parentType=x,B[1]=u.line;for(let F=0;F<d.length;F++)u.bMarks[F+e]=c[F],u.tShift[F+e]=d[F],u.sCount[F+e]=a[F],u.bsCount[F+e]=s[F];return u.blkIndent=w,!0}function oi(u,e,t,n){const r=u.eMarks[e];if(u.sCount[e]-u.blkIndent>=4)return!1;let i=u.bMarks[e]+u.tShift[e];const o=u.src.charCodeAt(i++);if(o!==42&&o!==45&&o!==95)return!1;let c=1;for(;i<r;){const a=u.src.charCodeAt(i++);if(a!==o&&!U(a))return!1;a===o&&c++}if(c<3)return!1;if(n)return!0;u.line=e+1;const s=u.push("hr","hr",0);return s.map=[e,u.line],s.markup=Array(c+1).join(String.fromCharCode(o)),!0}function wt(u,e){const t=u.eMarks[e];let n=u.bMarks[e]+u.tShift[e];const r=u.src.charCodeAt(n++);if(r!==42&&r!==45&&r!==43)return-1;if(n<t){const i=u.src.charCodeAt(n);if(!U(i))return-1}return n}function Ct(u,e){const t=u.bMarks[e]+u.tShift[e],n=u.eMarks[e];let r=t;if(r+1>=n)return-1;let i=u.src.charCodeAt(r++);if(i<48||i>57)return-1;for(;;){if(r>=n)return-1;if(i=u.src.charCodeAt(r++),i>=48&&i<=57){if(r-t>=10)return-1;continue}if(i===41||i===46)break;return-1}return r<n&&(i=u.src.charCodeAt(r),!U(i))?-1:r}function ci(u,e){const t=u.level+2;for(let n=e+2,r=u.tokens.length-2;n<r;n++)u.tokens[n].level===t&&u.tokens[n].type==="paragraph_open"&&(u.tokens[n+2].hidden=!0,u.tokens[n].hidden=!0,n+=2)}function si(u,e,t,n){let r,i,o,c,s=e,a=!0;if(u.sCount[s]-u.blkIndent>=4||u.listIndent>=0&&u.sCount[s]-u.listIndent>=4&&u.sCount[s]<u.blkIndent)return!1;let d=!1;n&&u.parentType==="paragraph"&&u.sCount[s]>=u.blkIndent&&(d=!0);let l,x,_;if((_=Ct(u,s))>=0){if(l=!0,o=u.bMarks[s]+u.tShift[s],x=Number(u.src.slice(o,_-1)),d&&x!==1)return!1}else if((_=wt(u,s))>=0)l=!1;else return!1;if(d&&u.skipSpaces(_)>=u.eMarks[s])return!1;if(n)return!0;const h=u.src.charCodeAt(_-1),w=u.tokens.length;l?(c=u.push("ordered_list_open","ol",1),x!==1&&(c.attrs=[["start",x]])):c=u.push("bullet_list_open","ul",1);const R=[s,0];c.map=R,c.markup=String.fromCharCode(h);let B=!1;const O=u.md.block.ruler.getRules("list"),F=u.parentType;for(u.parentType="list";s<t;){i=_,r=u.eMarks[s];const T=u.sCount[s]+_-(u.bMarks[s]+u.tShift[s]);let v=T;for(;i<r;){const N=u.src.charCodeAt(i);if(N===9)v+=4-(v+u.bsCount[s])%4;else if(N===32)v++;else break;i++}const M=i;let V;M>=r?V=1:V=v-T,V>4&&(V=1);const su=T+V;c=u.push("list_item_open","li",1),c.markup=String.fromCharCode(h);const au=[s,0];c.map=au,l&&(c.info=u.src.slice(o,_-1));const Tu=u.tight,$u=u.tShift[s],Eu=u.sCount[s],L=u.listIndent;if(u.listIndent=u.blkIndent,u.blkIndent=su,u.tight=!0,u.tShift[s]=M-u.bMarks[s],u.sCount[s]=v,M>=r&&u.isEmpty(s+1)?u.line=Math.min(u.line+2,t):u.md.block.tokenize(u,s,t,!0),(!u.tight||B)&&(a=!1),B=u.line-s>1&&u.isEmpty(u.line-1),u.blkIndent=u.listIndent,u.listIndent=L,u.tShift[s]=$u,u.sCount[s]=Eu,u.tight=Tu,c=u.push("list_item_close","li",-1),c.markup=String.fromCharCode(h),s=u.line,au[1]=s,s>=t||u.sCount[s]<u.blkIndent||u.sCount[s]-u.blkIndent>=4)break;let I=!1;for(let N=0,vu=O.length;N<vu;N++)if(O[N](u,s,t,!0)){I=!0;break}if(I)break;if(l){if(_=Ct(u,s),_<0)break;o=u.bMarks[s]+u.tShift[s]}else if(_=wt(u,s),_<0)break;if(h!==u.src.charCodeAt(_-1))break}return l?c=u.push("ordered_list_close","ol",-1):c=u.push("bullet_list_close","ul",-1),c.markup=String.fromCharCode(h),R[1]=s,u.line=s,u.parentType=F,a&&ci(u,w),!0}function ai(u,e,t,n){let r=0,i=u.bMarks[e]+u.tShift[e],o=u.eMarks[e],c=e+1;if(u.sCount[e]-u.blkIndent>=4||u.src.charCodeAt(i)!==91)return!1;for(;++i<o;)if(u.src.charCodeAt(i)===93&&u.src.charCodeAt(i-1)!==92){if(i+1===o||u.src.charCodeAt(i+1)!==58)return!1;break}const s=u.lineMax,a=u.md.block.ruler.getRules("reference"),d=u.parentType;for(u.parentType="reference";c<s&&!u.isEmpty(c);c++){if(u.sCount[c]-u.blkIndent>3||u.sCount[c]<0)continue;let v=!1;for(let M=0,V=a.length;M<V;M++)if(a[M](u,c,s,!0)){v=!0;break}if(v)break}const l=u.getLines(e,c,u.blkIndent,!1).trim();o=l.length;let x=-1;for(i=1;i<o;i++){const v=l.charCodeAt(i);if(v===91)return!1;if(v===93){x=i;break}else v===10?r++:v===92&&(i++,i<o&&l.charCodeAt(i)===10&&r++)}if(x<0||l.charCodeAt(x+1)!==58)return!1;for(i=x+2;i<o;i++){const v=l.charCodeAt(i);if(v===10)r++;else if(!U(v))break}const _=u.md.helpers.parseLinkDestination(l,i,o);if(!_.ok)return!1;const h=u.md.normalizeLink(_.str);if(!u.md.validateLink(h))return!1;i=_.pos,r+=_.lines;const w=i,R=r,B=i;for(;i<o;i++){const v=l.charCodeAt(i);if(v===10)r++;else if(!U(v))break}const O=u.md.helpers.parseLinkTitle(l,i,o);let F;for(i<o&&B!==i&&O.ok?(F=O.str,i=O.pos,r+=O.lines):(F="",i=w,r=R);i<o;){const v=l.charCodeAt(i);if(!U(v))break;i++}if(i<o&&l.charCodeAt(i)!==10&&F)for(F="",i=w,r=R;i<o;){const v=l.charCodeAt(i);if(!U(v))break;i++}if(i<o&&l.charCodeAt(i)!==10)return!1;const T=he(l.slice(1,x));return T?(n||(typeof u.env.references>"u"&&(u.env.references={}),typeof u.env.references[T]>"u"&&(u.env.references[T]={title:F,href:h}),u.parentType=d,u.line=e+r+1),!0):!1}const li=["address","article","aside","base","basefont","blockquote","body","caption","center","col","colgroup","dd","details","dialog","dir","div","dl","dt","fieldset","figcaption","figure","footer","form","frame","frameset","h1","h2","h3","h4","h5","h6","head","header","hr","html","iframe","legend","li","link","main","menu","menuitem","nav","noframes","ol","optgroup","option","p","param","section","source","summary","table","tbody","td","tfoot","th","thead","title","tr","track","ul"],fi="[a-zA-Z_:][a-zA-Z0-9:._-]*",di="[^\"'=<>`\\x00-\\x20]+",hi="'[^']*'",pi='"[^"]*"',bi="(?:"+di+"|"+hi+"|"+pi+")",mi="(?:\\s+"+fi+"(?:\\s*=\\s*"+bi+")?)",dn="<[A-Za-z][A-Za-z0-9\\-]*"+mi+"*\\s*\\/?>",hn="<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>",_i="<!---->|<!--(?:-?[^>-])(?:-?[^-])*-->",xi="<[?][\\s\\S]*?[?]>",gi="<![A-Z]+\\s+[^>]*>",yi="<!\\[CDATA\\[[\\s\\S]*?\\]\\]>",ki=new RegExp("^(?:"+dn+"|"+hn+"|"+_i+"|"+xi+"|"+gi+"|"+yi+")"),Ei=new RegExp("^(?:"+dn+"|"+hn+")"),Lu=[[/^<(script|pre|style|textarea)(?=(\s|>|$))/i,/<\/(script|pre|style|textarea)>/i,!0],[/^<!--/,/-->/,!0],[/^<\?/,/\?>/,!0],[/^<![A-Z]/,/>/,!0],[/^<!\[CDATA\[/,/\]\]>/,!0],[new RegExp("^</?("+li.join("|")+")(?=(\\s|/?>|$))","i"),/^$/,!0],[new RegExp(Ei.source+"\\s*$"),/^$/,!1]];function wi(u,e,t,n){let r=u.bMarks[e]+u.tShift[e],i=u.eMarks[e];if(u.sCount[e]-u.blkIndent>=4||!u.md.options.html||u.src.charCodeAt(r)!==60)return!1;let o=u.src.slice(r,i),c=0;for(;c<Lu.length&&!Lu[c][0].test(o);c++);if(c===Lu.length)return!1;if(n)return Lu[c][2];let s=e+1;if(!Lu[c][1].test(o)){for(;s<t&&!(u.sCount[s]<u.blkIndent);s++)if(r=u.bMarks[s]+u.tShift[s],i=u.eMarks[s],o=u.src.slice(r,i),Lu[c][1].test(o)){o.length!==0&&s++;break}}u.line=s;const a=u.push("html_block","",0);return a.map=[e,s],a.content=u.getLines(e,s,u.blkIndent,!0),!0}function Ci(u,e,t,n){let r=u.bMarks[e]+u.tShift[e],i=u.eMarks[e];if(u.sCount[e]-u.blkIndent>=4)return!1;let o=u.src.charCodeAt(r);if(o!==35||r>=i)return!1;let c=1;for(o=u.src.charCodeAt(++r);o===35&&r<i&&c<=6;)c++,o=u.src.charCodeAt(++r);if(c>6||r<i&&!U(o))return!1;if(n)return!0;i=u.skipSpacesBack(i,r);const s=u.skipCharsBack(i,35,r);s>r&&U(u.src.charCodeAt(s-1))&&(i=s),u.line=e+1;const a=u.push("heading_open","h"+String(c),1);a.markup="########".slice(0,c),a.map=[e,u.line];const d=u.push("inline","",0);d.content=u.src.slice(r,i).trim(),d.map=[e,u.line],d.children=[];const l=u.push("heading_close","h"+String(c),-1);return l.markup="########".slice(0,c),!0}function Di(u,e,t){const n=u.md.block.ruler.getRules("paragraph");if(u.sCount[e]-u.blkIndent>=4)return!1;const r=u.parentType;u.parentType="paragraph";let i=0,o,c=e+1;for(;c<t&&!u.isEmpty(c);c++){if(u.sCount[c]-u.blkIndent>3)continue;if(u.sCount[c]>=u.blkIndent){let _=u.bMarks[c]+u.tShift[c];const h=u.eMarks[c];if(_<h&&(o=u.src.charCodeAt(_),(o===45||o===61)&&(_=u.skipChars(_,o),_=u.skipSpaces(_),_>=h))){i=o===61?1:2;break}}if(u.sCount[c]<0)continue;let x=!1;for(let _=0,h=n.length;_<h;_++)if(n[_](u,c,t,!0)){x=!0;break}if(x)break}if(!i)return!1;const s=u.getLines(e,c,u.blkIndent,!1).trim();u.line=c+1;const a=u.push("heading_open","h"+String(i),1);a.markup=String.fromCharCode(o),a.map=[e,u.line];const d=u.push("inline","",0);d.content=s,d.map=[e,u.line-1],d.children=[];const l=u.push("heading_close","h"+String(i),-1);return l.markup=String.fromCharCode(o),u.parentType=r,!0}function Ai(u,e,t){const n=u.md.block.ruler.getRules("paragraph"),r=u.parentType;let i=e+1;for(u.parentType="paragraph";i<t&&!u.isEmpty(i);i++){if(u.sCount[i]-u.blkIndent>3||u.sCount[i]<0)continue;let a=!1;for(let d=0,l=n.length;d<l;d++)if(n[d](u,i,t,!0)){a=!0;break}if(a)break}const o=u.getLines(e,i,u.blkIndent,!1).trim();u.line=i;const c=u.push("paragraph_open","p",1);c.map=[e,u.line];const s=u.push("inline","",0);return s.content=o,s.map=[e,u.line],s.children=[],u.push("paragraph_close","p",-1),u.parentType=r,!0}const ne=[["table",ti,["paragraph","reference"]],["code",ni],["fence",ri,["paragraph","reference","blockquote","list"]],["blockquote",ii,["paragraph","reference","blockquote","list"]],["hr",oi,["paragraph","reference","blockquote","list"]],["list",si,["paragraph","reference","blockquote"]],["reference",ai],["html_block",wi,["paragraph","reference","blockquote"]],["heading",Ci,["paragraph","reference","blockquote"]],["lheading",Di],["paragraph",Ai]];function pe(){this.ruler=new eu;for(let u=0;u<ne.length;u++)this.ruler.push(ne[u][0],ne[u][1],{alt:(ne[u][2]||[]).slice()})}pe.prototype.tokenize=function(u,e,t){const n=this.ruler.getRules(""),r=n.length,i=u.md.options.maxNesting;let o=e,c=!1;for(;o<t&&(u.line=o=u.skipEmptyLines(o),!(o>=t||u.sCount[o]<u.blkIndent));){if(u.level>=i){u.line=t;break}const s=u.line;let a=!1;for(let d=0;d<r;d++)if(a=n[d](u,o,t,!1),a){if(s>=u.line)throw new Error("block rule didn't increment state.line");break}if(!a)throw new Error("none of the block rules matched");u.tight=!c,u.isEmpty(u.line-1)&&(c=!0),o=u.line,o<t&&u.isEmpty(o)&&(c=!0,o++,u.line=o)}};pe.prototype.parse=function(u,e,t,n){if(!u)return;const r=new this.State(u,e,t,n);this.tokenize(r,r.line,r.lineMax)};pe.prototype.State=_u;function Ku(u,e,t,n){this.src=u,this.env=t,this.md=e,this.tokens=n,this.tokens_meta=Array(n.length),this.pos=0,this.posMax=this.src.length,this.level=0,this.pending="",this.pendingLevel=0,this.cache={},this.delimiters=[],this._prev_delimiters=[],this.backticks={},this.backticksScanned=!1,this.linkLevel=0}Ku.prototype.pushPending=function(){const u=new cu("text","",0);return u.content=this.pending,u.level=this.pendingLevel,this.tokens.push(u),this.pending="",u};Ku.prototype.push=function(u,e,t){this.pending&&this.pushPending();const n=new cu(u,e,t);let r=null;return t<0&&(this.level--,this.delimiters=this._prev_delimiters.pop()),n.level=this.level,t>0&&(this.level++,this._prev_delimiters.push(this.delimiters),this.delimiters=[],r={delimiters:this.delimiters}),this.pendingLevel=this.level,this.tokens.push(n),this.tokens_meta.push(r),n};Ku.prototype.scanDelims=function(u,e){let t,n,r=!0,i=!0;const o=this.posMax,c=this.src.charCodeAt(u),s=u>0?this.src.charCodeAt(u-1):32;let a=u;for(;a<o&&this.src.charCodeAt(a)===c;)a++;const d=a-u,l=a<o?this.src.charCodeAt(a):32,x=Vu(s)||Gu(String.fromCharCode(s)),_=Vu(l)||Gu(String.fromCharCode(l)),h=Hu(s),w=Hu(l);return w?r=!1:_&&(h||x||(r=!1)),h?i=!1:x&&(w||_||(i=!1)),e?(t=r,n=i):(t=r&&(!i||x),n=i&&(!r||_)),{can_open:t,can_close:n,length:d}};Ku.prototype.Token=cu;function Fi(u){switch(u){case 10:case 33:case 35:case 36:case 37:case 38:case 42:case 43:case 45:case 58:case 60:case 61:case 62:case 64:case 91:case 92:case 93:case 94:case 95:case 96:case 123:case 125:case 126:return!0;default:return!1}}function vi(u,e){let t=u.pos;for(;t<u.posMax&&!Fi(u.src.charCodeAt(t));)t++;return t===u.pos?!1:(e||(u.pending+=u.src.slice(u.pos,t)),u.pos=t,!0)}const Ri=/(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i;function Si(u,e){if(!u.md.options.linkify||u.linkLevel>0)return!1;const t=u.pos,n=u.posMax;if(t+3>n||u.src.charCodeAt(t)!==58||u.src.charCodeAt(t+1)!==47||u.src.charCodeAt(t+2)!==47)return!1;const r=u.pending.match(Ri);if(!r)return!1;const i=r[1],o=u.md.linkify.matchAtStart(u.src.slice(t-i.length));if(!o)return!1;let c=o.url;if(c.length<=i.length)return!1;c=c.replace(/\*+$/,"");const s=u.md.normalizeLink(c);if(!u.md.validateLink(s))return!1;if(!e){u.pending=u.pending.slice(0,-i.length);const a=u.push("link_open","a",1);a.attrs=[["href",s]],a.markup="linkify",a.info="auto";const d=u.push("text","",0);d.content=u.md.normalizeLinkText(c);const l=u.push("link_close","a",-1);l.markup="linkify",l.info="auto"}return u.pos+=c.length-i.length,!0}function Ti(u,e){let t=u.pos;if(u.src.charCodeAt(t)!==10)return!1;const n=u.pending.length-1,r=u.posMax;if(!e)if(n>=0&&u.pending.charCodeAt(n)===32)if(n>=1&&u.pending.charCodeAt(n-1)===32){let i=n-1;for(;i>=1&&u.pending.charCodeAt(i-1)===32;)i--;u.pending=u.pending.slice(0,i),u.push("hardbreak","br",0)}else u.pending=u.pending.slice(0,-1),u.push("softbreak","br",0);else u.push("softbreak","br",0);for(t++;t<r&&U(u.src.charCodeAt(t));)t++;return u.pos=t,!0}const Xe=[];for(let u=0;u<256;u++)Xe.push(0);"\\!\"#$%&'()*+,./:;<=>?@[]^_`{|}~-".split("").forEach(function(u){Xe[u.charCodeAt(0)]=1});function Bi(u,e){let t=u.pos;const n=u.posMax;if(u.src.charCodeAt(t)!==92||(t++,t>=n))return!1;let r=u.src.charCodeAt(t);if(r===10){for(e||u.push("hardbreak","br",0),t++;t<n&&(r=u.src.charCodeAt(t),!!U(r));)t++;return u.pos=t,!0}let i=u.src[t];if(r>=55296&&r<=56319&&t+1<n){const c=u.src.charCodeAt(t+1);c>=56320&&c<=57343&&(i+=u.src[t+1],t++)}const o="\\"+i;if(!e){const c=u.push("text_special","",0);r<256&&Xe[r]!==0?c.content=i:c.content=o,c.markup=o,c.info="escape"}return u.pos=t+1,!0}function Oi(u,e){let t=u.pos;if(u.src.charCodeAt(t)!==96)return!1;const r=t;t++;const i=u.posMax;for(;t<i&&u.src.charCodeAt(t)===96;)t++;const o=u.src.slice(r,t),c=o.length;if(u.backticksScanned&&(u.backticks[c]||0)<=r)return e||(u.pending+=o),u.pos+=c,!0;let s=t,a;for(;(a=u.src.indexOf("`",s))!==-1;){for(s=a+1;s<i&&u.src.charCodeAt(s)===96;)s++;const d=s-a;if(d===c){if(!e){const l=u.push("code_inline","code",0);l.markup=o,l.content=u.src.slice(t,a).replace(/\n/g," ").replace(/^ (.+) $/,"$1")}return u.pos=s,!0}u.backticks[d]=a}return u.backticksScanned=!0,e||(u.pending+=o),u.pos+=c,!0}function Li(u,e){const t=u.pos,n=u.src.charCodeAt(t);if(e||n!==126)return!1;const r=u.scanDelims(u.pos,!0);let i=r.length;const o=String.fromCharCode(n);if(i<2)return!1;let c;i%2&&(c=u.push("text","",0),c.content=o,i--);for(let s=0;s<i;s+=2)c=u.push("text","",0),c.content=o+o,u.delimiters.push({marker:n,length:0,token:u.tokens.length-1,end:-1,open:r.can_open,close:r.can_close});return u.pos+=r.length,!0}function Dt(u,e){let t;const n=[],r=e.length;for(let i=0;i<r;i++){const o=e[i];if(o.marker!==126||o.end===-1)continue;const c=e[o.end];t=u.tokens[o.token],t.type="s_open",t.tag="s",t.nesting=1,t.markup="~~",t.content="",t=u.tokens[c.token],t.type="s_close",t.tag="s",t.nesting=-1,t.markup="~~",t.content="",u.tokens[c.token-1].type==="text"&&u.tokens[c.token-1].content==="~"&&n.push(c.token-1)}for(;n.length;){const i=n.pop();let o=i+1;for(;o<u.tokens.length&&u.tokens[o].type==="s_close";)o++;o--,i!==o&&(t=u.tokens[o],u.tokens[o]=u.tokens[i],u.tokens[i]=t)}}function Ni(u){const e=u.tokens_meta,t=u.tokens_meta.length;Dt(u,u.delimiters);for(let n=0;n<t;n++)e[n]&&e[n].delimiters&&Dt(u,e[n].delimiters)}const pn={tokenize:Li,postProcess:Ni};function Ii(u,e){const t=u.pos,n=u.src.charCodeAt(t);if(e||n!==95&&n!==42)return!1;const r=u.scanDelims(u.pos,n===42);for(let i=0;i<r.length;i++){const o=u.push("text","",0);o.content=String.fromCharCode(n),u.delimiters.push({marker:n,length:r.length,token:u.tokens.length-1,end:-1,open:r.can_open,close:r.can_close})}return u.pos+=r.length,!0}function At(u,e){const t=e.length;for(let n=t-1;n>=0;n--){const r=e[n];if(r.marker!==95&&r.marker!==42||r.end===-1)continue;const i=e[r.end],o=n>0&&e[n-1].end===r.end+1&&e[n-1].marker===r.marker&&e[n-1].token===r.token-1&&e[r.end+1].token===i.token+1,c=String.fromCharCode(r.marker),s=u.tokens[r.token];s.type=o?"strong_open":"em_open",s.tag=o?"strong":"em",s.nesting=1,s.markup=o?c+c:c,s.content="";const a=u.tokens[i.token];a.type=o?"strong_close":"em_close",a.tag=o?"strong":"em",a.nesting=-1,a.markup=o?c+c:c,a.content="",o&&(u.tokens[e[n-1].token].content="",u.tokens[e[r.end+1].token].content="",n--)}}function Pi(u){const e=u.tokens_meta,t=u.tokens_meta.length;At(u,u.delimiters);for(let n=0;n<t;n++)e[n]&&e[n].delimiters&&At(u,e[n].delimiters)}const bn={tokenize:Ii,postProcess:Pi};function Mi(u,e){let t,n,r,i,o="",c="",s=u.pos,a=!0;if(u.src.charCodeAt(u.pos)!==91)return!1;const d=u.pos,l=u.posMax,x=u.pos+1,_=u.md.helpers.parseLinkLabel(u,u.pos,!0);if(_<0)return!1;let h=_+1;if(h<l&&u.src.charCodeAt(h)===40){for(a=!1,h++;h<l&&(t=u.src.charCodeAt(h),!(!U(t)&&t!==10));h++);if(h>=l)return!1;if(s=h,r=u.md.helpers.parseLinkDestination(u.src,h,u.posMax),r.ok){for(o=u.md.normalizeLink(r.str),u.md.validateLink(o)?h=r.pos:o="",s=h;h<l&&(t=u.src.charCodeAt(h),!(!U(t)&&t!==10));h++);if(r=u.md.helpers.parseLinkTitle(u.src,h,u.posMax),h<l&&s!==h&&r.ok)for(c=r.str,h=r.pos;h<l&&(t=u.src.charCodeAt(h),!(!U(t)&&t!==10));h++);}(h>=l||u.src.charCodeAt(h)!==41)&&(a=!0),h++}if(a){if(typeof u.env.references>"u")return!1;if(h<l&&u.src.charCodeAt(h)===91?(s=h+1,h=u.md.helpers.parseLinkLabel(u,h),h>=0?n=u.src.slice(s,h++):h=_+1):h=_+1,n||(n=u.src.slice(x,_)),i=u.env.references[he(n)],!i)return u.pos=d,!1;o=i.href,c=i.title}if(!e){u.pos=x,u.posMax=_;const w=u.push("link_open","a",1),R=[["href",o]];w.attrs=R,c&&R.push(["title",c]),u.linkLevel++,u.md.inline.tokenize(u),u.linkLevel--,u.push("link_close","a",-1)}return u.pos=h,u.posMax=l,!0}function zi(u,e){let t,n,r,i,o,c,s,a,d="";const l=u.pos,x=u.posMax;if(u.src.charCodeAt(u.pos)!==33||u.src.charCodeAt(u.pos+1)!==91)return!1;const _=u.pos+2,h=u.md.helpers.parseLinkLabel(u,u.pos+1,!1);if(h<0)return!1;if(i=h+1,i<x&&u.src.charCodeAt(i)===40){for(i++;i<x&&(t=u.src.charCodeAt(i),!(!U(t)&&t!==10));i++);if(i>=x)return!1;for(a=i,c=u.md.helpers.parseLinkDestination(u.src,i,u.posMax),c.ok&&(d=u.md.normalizeLink(c.str),u.md.validateLink(d)?i=c.pos:d=""),a=i;i<x&&(t=u.src.charCodeAt(i),!(!U(t)&&t!==10));i++);if(c=u.md.helpers.parseLinkTitle(u.src,i,u.posMax),i<x&&a!==i&&c.ok)for(s=c.str,i=c.pos;i<x&&(t=u.src.charCodeAt(i),!(!U(t)&&t!==10));i++);else s="";if(i>=x||u.src.charCodeAt(i)!==41)return u.pos=l,!1;i++}else{if(typeof u.env.references>"u")return!1;if(i<x&&u.src.charCodeAt(i)===91?(a=i+1,i=u.md.helpers.parseLinkLabel(u,i),i>=0?r=u.src.slice(a,i++):i=h+1):i=h+1,r||(r=u.src.slice(_,h)),o=u.env.references[he(r)],!o)return u.pos=l,!1;d=o.href,s=o.title}if(!e){n=u.src.slice(_,h);const w=[];u.md.inline.parse(n,u.md,u.env,w);const R=u.push("image","img",0),B=[["src",d],["alt",""]];R.attrs=B,R.children=w,R.content=n,s&&B.push(["title",s])}return u.pos=i,u.posMax=x,!0}const $i=/^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/,qi=/^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;function ji(u,e){let t=u.pos;if(u.src.charCodeAt(t)!==60)return!1;const n=u.pos,r=u.posMax;for(;;){if(++t>=r)return!1;const o=u.src.charCodeAt(t);if(o===60)return!1;if(o===62)break}const i=u.src.slice(n+1,t);if(qi.test(i)){const o=u.md.normalizeLink(i);if(!u.md.validateLink(o))return!1;if(!e){const c=u.push("link_open","a",1);c.attrs=[["href",o]],c.markup="autolink",c.info="auto";const s=u.push("text","",0);s.content=u.md.normalizeLinkText(i);const a=u.push("link_close","a",-1);a.markup="autolink",a.info="auto"}return u.pos+=i.length+2,!0}if($i.test(i)){const o=u.md.normalizeLink("mailto:"+i);if(!u.md.validateLink(o))return!1;if(!e){const c=u.push("link_open","a",1);c.attrs=[["href",o]],c.markup="autolink",c.info="auto";const s=u.push("text","",0);s.content=u.md.normalizeLinkText(i);const a=u.push("link_close","a",-1);a.markup="autolink",a.info="auto"}return u.pos+=i.length+2,!0}return!1}function Ui(u){return/^<a[>\s]/i.test(u)}function Hi(u){return/^<\/a\s*>/i.test(u)}function Gi(u){const e=u|32;return e>=97&&e<=122}function Vi(u,e){if(!u.md.options.html)return!1;const t=u.posMax,n=u.pos;if(u.src.charCodeAt(n)!==60||n+2>=t)return!1;const r=u.src.charCodeAt(n+1);if(r!==33&&r!==63&&r!==47&&!Gi(r))return!1;const i=u.src.slice(n).match(ki);if(!i)return!1;if(!e){const o=u.push("html_inline","",0);o.content=i[0],Ui(o.content)&&u.linkLevel++,Hi(o.content)&&u.linkLevel--}return u.pos+=i[0].length,!0}const Wi=/^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,Zi=/^&([a-z][a-z0-9]{1,31});/i;function Ji(u,e){const t=u.pos,n=u.posMax;if(u.src.charCodeAt(t)!==38||t+1>=n)return!1;if(u.src.charCodeAt(t+1)===35){const i=u.src.slice(t).match(Wi);if(i){if(!e){const o=i[1][0].toLowerCase()==="x"?parseInt(i[1].slice(1),16):parseInt(i[1],10),c=u.push("text_special","",0);c.content=Je(o)?ae(o):ae(65533),c.markup=i[0],c.info="entity"}return u.pos+=i[0].length,!0}}else{const i=u.src.slice(t).match(Zi);if(i){const o=cn(i[0]);if(o!==i[0]){if(!e){const c=u.push("text_special","",0);c.content=o,c.markup=i[0],c.info="entity"}return u.pos+=i[0].length,!0}}}return!1}function Ft(u){const e={},t=u.length;if(!t)return;let n=0,r=-2;const i=[];for(let o=0;o<t;o++){const c=u[o];if(i.push(0),(u[n].marker!==c.marker||r!==c.token-1)&&(n=o),r=c.token,c.length=c.length||0,!c.close)continue;e.hasOwnProperty(c.marker)||(e[c.marker]=[-1,-1,-1,-1,-1,-1]);const s=e[c.marker][(c.open?3:0)+c.length%3];let a=n-i[n]-1,d=a;for(;a>s;a-=i[a]+1){const l=u[a];if(l.marker===c.marker&&l.open&&l.end<0){let x=!1;if((l.close||c.open)&&(l.length+c.length)%3===0&&(l.length%3!==0||c.length%3!==0)&&(x=!0),!x){const _=a>0&&!u[a-1].open?i[a-1]+1:0;i[o]=o-a+_,i[a]=_,c.open=!1,l.end=o,l.close=!1,d=-1,r=-2;break}}}d!==-1&&(e[c.marker][(c.open?3:0)+(c.length||0)%3]=d)}}function Ki(u){const e=u.tokens_meta,t=u.tokens_meta.length;Ft(u.delimiters);for(let n=0;n<t;n++)e[n]&&e[n].delimiters&&Ft(e[n].delimiters)}function Xi(u){let e,t,n=0;const r=u.tokens,i=u.tokens.length;for(e=t=0;e<i;e++)r[e].nesting<0&&n--,r[e].level=n,r[e].nesting>0&&n++,r[e].type==="text"&&e+1<i&&r[e+1].type==="text"?r[e+1].content=r[e].content+r[e+1].content:(e!==t&&(r[t]=r[e]),t++);e!==t&&(r.length=t)}const De=[["text",vi],["linkify",Si],["newline",Ti],["escape",Bi],["backticks",Oi],["strikethrough",pn.tokenize],["emphasis",bn.tokenize],["link",Mi],["image",zi],["autolink",ji],["html_inline",Vi],["entity",Ji]],Ae=[["balance_pairs",Ki],["strikethrough",pn.postProcess],["emphasis",bn.postProcess],["fragments_join",Xi]];function Xu(){this.ruler=new eu;for(let u=0;u<De.length;u++)this.ruler.push(De[u][0],De[u][1]);this.ruler2=new eu;for(let u=0;u<Ae.length;u++)this.ruler2.push(Ae[u][0],Ae[u][1])}Xu.prototype.skipToken=function(u){const e=u.pos,t=this.ruler.getRules(""),n=t.length,r=u.md.options.maxNesting,i=u.cache;if(typeof i[e]<"u"){u.pos=i[e];return}let o=!1;if(u.level<r){for(let c=0;c<n;c++)if(u.level++,o=t[c](u,!0),u.level--,o){if(e>=u.pos)throw new Error("inline rule didn't increment state.pos");break}}else u.pos=u.posMax;o||u.pos++,i[e]=u.pos};Xu.prototype.tokenize=function(u){const e=this.ruler.getRules(""),t=e.length,n=u.posMax,r=u.md.options.maxNesting;for(;u.pos<n;){const i=u.pos;let o=!1;if(u.level<r){for(let c=0;c<t;c++)if(o=e[c](u,!1),o){if(i>=u.pos)throw new Error("inline rule didn't increment state.pos");break}}if(o){if(u.pos>=n)break;continue}u.pending+=u.src[u.pos++]}u.pending&&u.pushPending()};Xu.prototype.parse=function(u,e,t,n){const r=new this.State(u,e,t,n);this.tokenize(r);const i=this.ruler2.getRules(""),o=i.length;for(let c=0;c<o;c++)i[c](r)};Xu.prototype.State=Ku;function Qi(u){const e={};u=u||{},e.src_Any=tn.source,e.src_Cc=nn.source,e.src_Z=rn.source,e.src_P=We.source,e.src_ZPCc=[e.src_Z,e.src_P,e.src_Cc].join("|"),e.src_ZCc=[e.src_Z,e.src_Cc].join("|");const t="[><｜]";return e.src_pseudo_letter="(?:(?!"+t+"|"+e.src_ZPCc+")"+e.src_Any+")",e.src_ip4="(?:(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)",e.src_auth="(?:(?:(?!"+e.src_ZCc+"|[@/\\[\\]()]).)+@)?",e.src_port="(?::(?:6(?:[0-4]\\d{3}|5(?:[0-4]\\d{2}|5(?:[0-2]\\d|3[0-5])))|[1-5]?\\d{1,4}))?",e.src_host_terminator="(?=$|"+t+"|"+e.src_ZPCc+")(?!"+(u["---"]?"-(?!--)|":"-|")+"_|:\\d|\\.-|\\.(?!$|"+e.src_ZPCc+"))",e.src_path="(?:[/?#](?:(?!"+e.src_ZCc+"|"+t+`|[()[\\]{}.,"'?!\\-;]).|\\[(?:(?!`+e.src_ZCc+"|\\]).)*\\]|\\((?:(?!"+e.src_ZCc+"|[)]).)*\\)|\\{(?:(?!"+e.src_ZCc+'|[}]).)*\\}|\\"(?:(?!'+e.src_ZCc+`|["]).)+\\"|\\'(?:(?!`+e.src_ZCc+"|[']).)+\\'|\\'(?="+e.src_pseudo_letter+"|[-])|\\.{2,}[a-zA-Z0-9%/&]|\\.(?!"+e.src_ZCc+"|[.]|$)|"+(u["---"]?"\\-(?!--(?:[^-]|$))(?:-*)|":"\\-+|")+",(?!"+e.src_ZCc+"|$)|;(?!"+e.src_ZCc+"|$)|\\!+(?!"+e.src_ZCc+"|[!]|$)|\\?(?!"+e.src_ZCc+"|[?]|$))+|\\/)?",e.src_email_name='[\\-;:&=\\+\\$,\\.a-zA-Z0-9_][\\-;:&=\\+\\$,\\"\\.a-zA-Z0-9_]*',e.src_xn="xn--[a-z0-9\\-]{1,59}",e.src_domain_root="(?:"+e.src_xn+"|"+e.src_pseudo_letter+"{1,63})",e.src_domain="(?:"+e.src_xn+"|(?:"+e.src_pseudo_letter+")|(?:"+e.src_pseudo_letter+"(?:-|"+e.src_pseudo_letter+"){0,61}"+e.src_pseudo_letter+"))",e.src_host="(?:(?:(?:(?:"+e.src_domain+")\\.)*"+e.src_domain+"))",e.tpl_host_fuzzy="(?:"+e.src_ip4+"|(?:(?:(?:"+e.src_domain+")\\.)+(?:%TLDS%)))",e.tpl_host_no_ip_fuzzy="(?:(?:(?:"+e.src_domain+")\\.)+(?:%TLDS%))",e.src_host_strict=e.src_host+e.src_host_terminator,e.tpl_host_fuzzy_strict=e.tpl_host_fuzzy+e.src_host_terminator,e.src_host_port_strict=e.src_host+e.src_port+e.src_host_terminator,e.tpl_host_port_fuzzy_strict=e.tpl_host_fuzzy+e.src_port+e.src_host_terminator,e.tpl_host_port_no_ip_fuzzy_strict=e.tpl_host_no_ip_fuzzy+e.src_port+e.src_host_terminator,e.tpl_host_fuzzy_test="localhost|www\\.|\\.\\d{1,3}\\.|(?:\\.(?:%TLDS%)(?:"+e.src_ZPCc+"|>|$))",e.tpl_email_fuzzy="(^|"+t+'|"|\\(|'+e.src_ZCc+")("+e.src_email_name+"@"+e.tpl_host_fuzzy_strict+")",e.tpl_link_fuzzy="(^|(?![.:/\\-_@])(?:[$+<=>^`|｜]|"+e.src_ZPCc+"))((?![$+<=>^`|｜])"+e.tpl_host_port_fuzzy_strict+e.src_path+")",e.tpl_link_no_ip_fuzzy="(^|(?![.:/\\-_@])(?:[$+<=>^`|｜]|"+e.src_ZPCc+"))((?![$+<=>^`|｜])"+e.tpl_host_port_no_ip_fuzzy_strict+e.src_path+")",e}function Ie(u){return Array.prototype.slice.call(arguments,1).forEach(function(t){t&&Object.keys(t).forEach(function(n){u[n]=t[n]})}),u}function be(u){return Object.prototype.toString.call(u)}function Yi(u){return be(u)==="[object String]"}function uo(u){return be(u)==="[object Object]"}function eo(u){return be(u)==="[object RegExp]"}function vt(u){return be(u)==="[object Function]"}function to(u){return u.replace(/[.?*+^$[\]\\(){}|-]/g,"\\$&")}const mn={fuzzyLink:!0,fuzzyEmail:!0,fuzzyIP:!1};function no(u){return Object.keys(u||{}).reduce(function(e,t){return e||mn.hasOwnProperty(t)},!1)}const ro={"http:":{validate:function(u,e,t){const n=u.slice(e);return t.re.http||(t.re.http=new RegExp("^\\/\\/"+t.re.src_auth+t.re.src_host_port_strict+t.re.src_path,"i")),t.re.http.test(n)?n.match(t.re.http)[0].length:0}},"https:":"http:","ftp:":"http:","//":{validate:function(u,e,t){const n=u.slice(e);return t.re.no_http||(t.re.no_http=new RegExp("^"+t.re.src_auth+"(?:localhost|(?:(?:"+t.re.src_domain+")\\.)+"+t.re.src_domain_root+")"+t.re.src_port+t.re.src_host_terminator+t.re.src_path,"i")),t.re.no_http.test(n)?e>=3&&u[e-3]===":"||e>=3&&u[e-3]==="/"?0:n.match(t.re.no_http)[0].length:0}},"mailto:":{validate:function(u,e,t){const n=u.slice(e);return t.re.mailto||(t.re.mailto=new RegExp("^"+t.re.src_email_name+"@"+t.re.src_host_strict,"i")),t.re.mailto.test(n)?n.match(t.re.mailto)[0].length:0}}},io="a[cdefgilmnoqrstuwxz]|b[abdefghijmnorstvwyz]|c[acdfghiklmnoruvwxyz]|d[ejkmoz]|e[cegrstu]|f[ijkmor]|g[abdefghilmnpqrstuwy]|h[kmnrtu]|i[delmnoqrst]|j[emop]|k[eghimnprwyz]|l[abcikrstuvy]|m[acdeghklmnopqrstuvwxyz]|n[acefgilopruz]|om|p[aefghklmnrstwy]|qa|r[eosuw]|s[abcdeghijklmnortuvxyz]|t[cdfghjklmnortvwz]|u[agksyz]|v[aceginu]|w[fs]|y[et]|z[amw]",oo="biz|com|edu|gov|net|org|pro|web|xxx|aero|asia|coop|info|museum|name|shop|рф".split("|");function co(u){u.__index__=-1,u.__text_cache__=""}function so(u){return function(e,t){const n=e.slice(t);return u.test(n)?n.match(u)[0].length:0}}function Rt(){return function(u,e){e.normalize(u)}}function le(u){const e=u.re=Qi(u.__opts__),t=u.__tlds__.slice();u.onCompile(),u.__tlds_replaced__||t.push(io),t.push(e.src_xn),e.src_tlds=t.join("|");function n(c){return c.replace("%TLDS%",e.src_tlds)}e.email_fuzzy=RegExp(n(e.tpl_email_fuzzy),"i"),e.link_fuzzy=RegExp(n(e.tpl_link_fuzzy),"i"),e.link_no_ip_fuzzy=RegExp(n(e.tpl_link_no_ip_fuzzy),"i"),e.host_fuzzy_test=RegExp(n(e.tpl_host_fuzzy_test),"i");const r=[];u.__compiled__={};function i(c,s){throw new Error('(LinkifyIt) Invalid schema "'+c+'": '+s)}Object.keys(u.__schemas__).forEach(function(c){const s=u.__schemas__[c];if(s===null)return;const a={validate:null,link:null};if(u.__compiled__[c]=a,uo(s)){eo(s.validate)?a.validate=so(s.validate):vt(s.validate)?a.validate=s.validate:i(c,s),vt(s.normalize)?a.normalize=s.normalize:s.normalize?i(c,s):a.normalize=Rt();return}if(Yi(s)){r.push(c);return}i(c,s)}),r.forEach(function(c){u.__compiled__[u.__schemas__[c]]&&(u.__compiled__[c].validate=u.__compiled__[u.__schemas__[c]].validate,u.__compiled__[c].normalize=u.__compiled__[u.__schemas__[c]].normalize)}),u.__compiled__[""]={validate:null,normalize:Rt()};const o=Object.keys(u.__compiled__).filter(function(c){return c.length>0&&u.__compiled__[c]}).map(to).join("|");u.re.schema_test=RegExp("(^|(?!_)(?:[><｜]|"+e.src_ZPCc+"))("+o+")","i"),u.re.schema_search=RegExp("(^|(?!_)(?:[><｜]|"+e.src_ZPCc+"))("+o+")","ig"),u.re.schema_at_start=RegExp("^"+u.re.schema_search.source,"i"),u.re.pretest=RegExp("("+u.re.schema_test.source+")|("+u.re.host_fuzzy_test.source+")|@","i"),co(u)}function ao(u,e){const t=u.__index__,n=u.__last_index__,r=u.__text_cache__.slice(t,n);this.schema=u.__schema__.toLowerCase(),this.index=t+e,this.lastIndex=n+e,this.raw=r,this.text=r,this.url=r}function Pe(u,e){const t=new ao(u,e);return u.__compiled__[t.schema].normalize(t,u),t}function ru(u,e){if(!(this instanceof ru))return new ru(u,e);e||no(u)&&(e=u,u={}),this.__opts__=Ie({},mn,e),this.__index__=-1,this.__last_index__=-1,this.__schema__="",this.__text_cache__="",this.__schemas__=Ie({},ro,u),this.__compiled__={},this.__tlds__=oo,this.__tlds_replaced__=!1,this.re={},le(this)}ru.prototype.add=function(e,t){return this.__schemas__[e]=t,le(this),this};ru.prototype.set=function(e){return this.__opts__=Ie(this.__opts__,e),this};ru.prototype.test=function(e){if(this.__text_cache__=e,this.__index__=-1,!e.length)return!1;let t,n,r,i,o,c,s,a,d;if(this.re.schema_test.test(e)){for(s=this.re.schema_search,s.lastIndex=0;(t=s.exec(e))!==null;)if(i=this.testSchemaAt(e,t[2],s.lastIndex),i){this.__schema__=t[2],this.__index__=t.index+t[1].length,this.__last_index__=t.index+t[0].length+i;break}}return this.__opts__.fuzzyLink&&this.__compiled__["http:"]&&(a=e.search(this.re.host_fuzzy_test),a>=0&&(this.__index__<0||a<this.__index__)&&(n=e.match(this.__opts__.fuzzyIP?this.re.link_fuzzy:this.re.link_no_ip_fuzzy))!==null&&(o=n.index+n[1].length,(this.__index__<0||o<this.__index__)&&(this.__schema__="",this.__index__=o,this.__last_index__=n.index+n[0].length))),this.__opts__.fuzzyEmail&&this.__compiled__["mailto:"]&&(d=e.indexOf("@"),d>=0&&(r=e.match(this.re.email_fuzzy))!==null&&(o=r.index+r[1].length,c=r.index+r[0].length,(this.__index__<0||o<this.__index__||o===this.__index__&&c>this.__last_index__)&&(this.__schema__="mailto:",this.__index__=o,this.__last_index__=c))),this.__index__>=0};ru.prototype.pretest=function(e){return this.re.pretest.test(e)};ru.prototype.testSchemaAt=function(e,t,n){return this.__compiled__[t.toLowerCase()]?this.__compiled__[t.toLowerCase()].validate(e,n,this):0};ru.prototype.match=function(e){const t=[];let n=0;this.__index__>=0&&this.__text_cache__===e&&(t.push(Pe(this,n)),n=this.__last_index__);let r=n?e.slice(n):e;for(;this.test(r);)t.push(Pe(this,n)),r=r.slice(this.__last_index__),n+=this.__last_index__;return t.length?t:null};ru.prototype.matchAtStart=function(e){if(this.__text_cache__=e,this.__index__=-1,!e.length)return null;const t=this.re.schema_at_start.exec(e);if(!t)return null;const n=this.testSchemaAt(e,t[2],t[0].length);return n?(this.__schema__=t[2],this.__index__=t.index+t[1].length,this.__last_index__=t.index+t[0].length+n,Pe(this,0)):null};ru.prototype.tlds=function(e,t){return e=Array.isArray(e)?e:[e],t?(this.__tlds__=this.__tlds__.concat(e).sort().filter(function(n,r,i){return n!==i[r-1]}).reverse(),le(this),this):(this.__tlds__=e.slice(),this.__tlds_replaced__=!0,le(this),this)};ru.prototype.normalize=function(e){e.schema||(e.url="http://"+e.url),e.schema==="mailto:"&&!/^mailto:/i.test(e.url)&&(e.url="mailto:"+e.url)};ru.prototype.onCompile=function(){};const Nu=2147483647,hu=36,Qe=1,Wu=26,lo=38,fo=700,_n=72,xn=128,gn="-",ho=/^xn--/,po=/[^\0-\x7F]/,bo=/[\x2E\u3002\uFF0E\uFF61]/g,mo={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)","invalid-input":"Invalid input"},Fe=hu-Qe,pu=Math.floor,ve=String.fromCharCode;function Cu(u){throw new RangeError(mo[u])}function _o(u,e){const t=[];let n=u.length;for(;n--;)t[n]=e(u[n]);return t}function yn(u,e){const t=u.split("@");let n="";t.length>1&&(n=t[0]+"@",u=t[1]),u=u.replace(bo,".");const r=u.split("."),i=_o(r,e).join(".");return n+i}function kn(u){const e=[];let t=0;const n=u.length;for(;t<n;){const r=u.charCodeAt(t++);if(r>=55296&&r<=56319&&t<n){const i=u.charCodeAt(t++);(i&64512)==56320?e.push(((r&1023)<<10)+(i&1023)+65536):(e.push(r),t--)}else e.push(r)}return e}const xo=u=>String.fromCodePoint(...u),go=function(u){return u>=48&&u<58?26+(u-48):u>=65&&u<91?u-65:u>=97&&u<123?u-97:hu},St=function(u,e){return u+22+75*(u<26)-((e!=0)<<5)},En=function(u,e,t){let n=0;for(u=t?pu(u/fo):u>>1,u+=pu(u/e);u>Fe*Wu>>1;n+=hu)u=pu(u/Fe);return pu(n+(Fe+1)*u/(u+lo))},wn=function(u){const e=[],t=u.length;let n=0,r=xn,i=_n,o=u.lastIndexOf(gn);o<0&&(o=0);for(let c=0;c<o;++c)u.charCodeAt(c)>=128&&Cu("not-basic"),e.push(u.charCodeAt(c));for(let c=o>0?o+1:0;c<t;){const s=n;for(let d=1,l=hu;;l+=hu){c>=t&&Cu("invalid-input");const x=go(u.charCodeAt(c++));x>=hu&&Cu("invalid-input"),x>pu((Nu-n)/d)&&Cu("overflow"),n+=x*d;const _=l<=i?Qe:l>=i+Wu?Wu:l-i;if(x<_)break;const h=hu-_;d>pu(Nu/h)&&Cu("overflow"),d*=h}const a=e.length+1;i=En(n-s,a,s==0),pu(n/a)>Nu-r&&Cu("overflow"),r+=pu(n/a),n%=a,e.splice(n++,0,r)}return String.fromCodePoint(...e)},Cn=function(u){const e=[];u=kn(u);const t=u.length;let n=xn,r=0,i=_n;for(const s of u)s<128&&e.push(ve(s));const o=e.length;let c=o;for(o&&e.push(gn);c<t;){let s=Nu;for(const d of u)d>=n&&d<s&&(s=d);const a=c+1;s-n>pu((Nu-r)/a)&&Cu("overflow"),r+=(s-n)*a,n=s;for(const d of u)if(d<n&&++r>Nu&&Cu("overflow"),d===n){let l=r;for(let x=hu;;x+=hu){const _=x<=i?Qe:x>=i+Wu?Wu:x-i;if(l<_)break;const h=l-_,w=hu-_;e.push(ve(St(_+h%w,0))),l=pu(h/w)}e.push(ve(St(l,0))),i=En(r,a,c===o),r=0,++c}++r,++n}return e.join("")},yo=function(u){return yn(u,function(e){return ho.test(e)?wn(e.slice(4).toLowerCase()):e})},ko=function(u){return yn(u,function(e){return po.test(e)?"xn--"+Cn(e):e})},Dn={version:"2.3.1",ucs2:{decode:kn,encode:xo},decode:wn,encode:Cn,toASCII:ko,toUnicode:yo},Eo={options:{html:!1,xhtmlOut:!1,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:100},components:{core:{},block:{},inline:{}}},wo={options:{html:!1,xhtmlOut:!1,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:20},components:{core:{rules:["normalize","block","inline","text_join"]},block:{rules:["paragraph"]},inline:{rules:["text"],rules2:["balance_pairs","fragments_join"]}}},Co={options:{html:!0,xhtmlOut:!0,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:20},components:{core:{rules:["normalize","block","inline","text_join"]},block:{rules:["blockquote","code","fence","heading","hr","html_block","lheading","list","reference","paragraph"]},inline:{rules:["autolink","backticks","emphasis","entity","escape","html_inline","image","link","newline","text"],rules2:["balance_pairs","emphasis","fragments_join"]}}},Do={default:Eo,zero:wo,commonmark:Co},Ao=/^(vbscript|javascript|file|data):/,Fo=/^data:image\/(gif|png|jpeg|webp);/;function vo(u){const e=u.trim().toLowerCase();return Ao.test(e)?Fo.test(e):!0}const An=["http:","https:","mailto:"];function Ro(u){const e=Ve(u,!0);if(e.hostname&&(!e.protocol||An.indexOf(e.protocol)>=0))try{e.hostname=Dn.toASCII(e.hostname)}catch{}return Ju(Ge(e))}function So(u){const e=Ve(u,!0);if(e.hostname&&(!e.protocol||An.indexOf(e.protocol)>=0))try{e.hostname=Dn.toUnicode(e.hostname)}catch{}return Iu(Ge(e),Iu.defaultChars+"%")}function ou(u,e){if(!(this instanceof ou))return new ou(u,e);e||Ze(u)||(e=u||{},u="default"),this.inline=new Xu,this.block=new pe,this.core=new Ke,this.renderer=new Mu,this.linkify=new ru,this.validateLink=vo,this.normalizeLink=Ro,this.normalizeLinkText=So,this.utils=B0,this.helpers=de({},I0),this.options={},this.configure(u),e&&this.set(e)}ou.prototype.set=function(u){return de(this.options,u),this};ou.prototype.configure=function(u){const e=this;if(Ze(u)){const t=u;if(u=Do[t],!u)throw new Error('Wrong `markdown-it` preset "'+t+'", check name')}if(!u)throw new Error("Wrong `markdown-it` preset, can't be empty");return u.options&&e.set(u.options),u.components&&Object.keys(u.components).forEach(function(t){u.components[t].rules&&e[t].ruler.enableOnly(u.components[t].rules),u.components[t].rules2&&e[t].ruler2.enableOnly(u.components[t].rules2)}),this};ou.prototype.enable=function(u,e){let t=[];Array.isArray(u)||(u=[u]),["core","block","inline"].forEach(function(r){t=t.concat(this[r].ruler.enable(u,!0))},this),t=t.concat(this.inline.ruler2.enable(u,!0));const n=u.filter(function(r){return t.indexOf(r)<0});if(n.length&&!e)throw new Error("MarkdownIt. Failed to enable unknown rule(s): "+n);return this};ou.prototype.disable=function(u,e){let t=[];Array.isArray(u)||(u=[u]),["core","block","inline"].forEach(function(r){t=t.concat(this[r].ruler.disable(u,!0))},this),t=t.concat(this.inline.ruler2.disable(u,!0));const n=u.filter(function(r){return t.indexOf(r)<0});if(n.length&&!e)throw new Error("MarkdownIt. Failed to disable unknown rule(s): "+n);return this};ou.prototype.use=function(u){const e=[this].concat(Array.prototype.slice.call(arguments,1));return u.apply(u,e),this};ou.prototype.parse=function(u,e){if(typeof u!="string")throw new Error("Input data should be a String");const t=new this.core.State(u,this,e);return this.core.process(t),t.tokens};ou.prototype.render=function(u,e){return e=e||{},this.renderer.render(this.parse(u,e),this.options,e)};ou.prototype.parseInline=function(u,e){const t=new this.core.State(u,this,e);return t.inlineMode=!0,this.core.process(t),t.tokens};ou.prototype.renderInline=function(u,e){return e=e||{},this.renderer.render(this.parseInline(u,e),this.options,e)};function Fn(u,e){return function(){return u.apply(e,arguments)}}const{toString:To}=Object.prototype,{getPrototypeOf:Ye}=Object,me=(u=>e=>{const t=To.call(e);return u[t]||(u[t]=t.slice(8,-1).toLowerCase())})(Object.create(null)),xu=u=>(u=u.toLowerCase(),e=>me(e)===u),_e=u=>e=>typeof e===u,{isArray:zu}=Array,Zu=_e("undefined");function Bo(u){return u!==null&&!Zu(u)&&u.constructor!==null&&!Zu(u.constructor)&&iu(u.constructor.isBuffer)&&u.constructor.isBuffer(u)}const vn=xu("ArrayBuffer");function Oo(u){let e;return typeof ArrayBuffer<"u"&&ArrayBuffer.isView?e=ArrayBuffer.isView(u):e=u&&u.buffer&&vn(u.buffer),e}const Lo=_e("string"),iu=_e("function"),Rn=_e("number"),xe=u=>u!==null&&typeof u=="object",No=u=>u===!0||u===!1,ie=u=>{if(me(u)!=="object")return!1;const e=Ye(u);return(e===null||e===Object.prototype||Object.getPrototypeOf(e)===null)&&!(Symbol.toStringTag in u)&&!(Symbol.iterator in u)},Io=xu("Date"),Po=xu("File"),Mo=xu("Blob"),zo=xu("FileList"),$o=u=>xe(u)&&iu(u.pipe),qo=u=>{let e;return u&&(typeof FormData=="function"&&u instanceof FormData||iu(u.append)&&((e=me(u))==="formdata"||e==="object"&&iu(u.toString)&&u.toString()==="[object FormData]"))},jo=xu("URLSearchParams"),Uo=u=>u.trim?u.trim():u.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"");function Qu(u,e,{allOwnKeys:t=!1}={}){if(u===null||typeof u>"u")return;let n,r;if(typeof u!="object"&&(u=[u]),zu(u))for(n=0,r=u.length;n<r;n++)e.call(null,u[n],n,u);else{const i=t?Object.getOwnPropertyNames(u):Object.keys(u),o=i.length;let c;for(n=0;n<o;n++)c=i[n],e.call(null,u[c],c,u)}}function Sn(u,e){e=e.toLowerCase();const t=Object.keys(u);let n=t.length,r;for(;n-- >0;)if(r=t[n],e===r.toLowerCase())return r;return null}const Tn=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:global,Bn=u=>!Zu(u)&&u!==Tn;function Me(){const{caseless:u}=Bn(this)&&this||{},e={},t=(n,r)=>{const i=u&&Sn(e,r)||r;ie(e[i])&&ie(n)?e[i]=Me(e[i],n):ie(n)?e[i]=Me({},n):zu(n)?e[i]=n.slice():e[i]=n};for(let n=0,r=arguments.length;n<r;n++)arguments[n]&&Qu(arguments[n],t);return e}const Ho=(u,e,t,{allOwnKeys:n}={})=>(Qu(e,(r,i)=>{t&&iu(r)?u[i]=Fn(r,t):u[i]=r},{allOwnKeys:n}),u),Go=u=>(u.charCodeAt(0)===65279&&(u=u.slice(1)),u),Vo=(u,e,t,n)=>{u.prototype=Object.create(e.prototype,n),u.prototype.constructor=u,Object.defineProperty(u,"super",{value:e.prototype}),t&&Object.assign(u.prototype,t)},Wo=(u,e,t,n)=>{let r,i,o;const c={};if(e=e||{},u==null)return e;do{for(r=Object.getOwnPropertyNames(u),i=r.length;i-- >0;)o=r[i],(!n||n(o,u,e))&&!c[o]&&(e[o]=u[o],c[o]=!0);u=t!==!1&&Ye(u)}while(u&&(!t||t(u,e))&&u!==Object.prototype);return e},Zo=(u,e,t)=>{u=String(u),(t===void 0||t>u.length)&&(t=u.length),t-=e.length;const n=u.indexOf(e,t);return n!==-1&&n===t},Jo=u=>{if(!u)return null;if(zu(u))return u;let e=u.length;if(!Rn(e))return null;const t=new Array(e);for(;e-- >0;)t[e]=u[e];return t},Ko=(u=>e=>u&&e instanceof u)(typeof Uint8Array<"u"&&Ye(Uint8Array)),Xo=(u,e)=>{const n=(u&&u[Symbol.iterator]).call(u);let r;for(;(r=n.next())&&!r.done;){const i=r.value;e.call(u,i[0],i[1])}},Qo=(u,e)=>{let t;const n=[];for(;(t=u.exec(e))!==null;)n.push(t);return n},Yo=xu("HTMLFormElement"),uc=u=>u.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g,function(t,n,r){return n.toUpperCase()+r}),Tt=(({hasOwnProperty:u})=>(e,t)=>u.call(e,t))(Object.prototype),ec=xu("RegExp"),On=(u,e)=>{const t=Object.getOwnPropertyDescriptors(u),n={};Qu(t,(r,i)=>{let o;(o=e(r,i,u))!==!1&&(n[i]=o||r)}),Object.defineProperties(u,n)},tc=u=>{On(u,(e,t)=>{if(iu(u)&&["arguments","caller","callee"].indexOf(t)!==-1)return!1;const n=u[t];if(iu(n)){if(e.enumerable=!1,"writable"in e){e.writable=!1;return}e.set||(e.set=()=>{throw Error("Can not rewrite read-only method '"+t+"'")})}})},nc=(u,e)=>{const t={},n=r=>{r.forEach(i=>{t[i]=!0})};return zu(u)?n(u):n(String(u).split(e)),t},rc=()=>{},ic=(u,e)=>(u=+u,Number.isFinite(u)?u:e),Re="abcdefghijklmnopqrstuvwxyz",Bt="0123456789",Ln={DIGIT:Bt,ALPHA:Re,ALPHA_DIGIT:Re+Re.toUpperCase()+Bt},oc=(u=16,e=Ln.ALPHA_DIGIT)=>{let t="";const{length:n}=e;for(;u--;)t+=e[Math.random()*n|0];return t};function cc(u){return!!(u&&iu(u.append)&&u[Symbol.toStringTag]==="FormData"&&u[Symbol.iterator])}const sc=u=>{const e=new Array(10),t=(n,r)=>{if(xe(n)){if(e.indexOf(n)>=0)return;if(!("toJSON"in n)){e[r]=n;const i=zu(n)?[]:{};return Qu(n,(o,c)=>{const s=t(o,r+1);!Zu(s)&&(i[c]=s)}),e[r]=void 0,i}}return n};return t(u,0)},ac=xu("AsyncFunction"),lc=u=>u&&(xe(u)||iu(u))&&iu(u.then)&&iu(u.catch),E={isArray:zu,isArrayBuffer:vn,isBuffer:Bo,isFormData:qo,isArrayBufferView:Oo,isString:Lo,isNumber:Rn,isBoolean:No,isObject:xe,isPlainObject:ie,isUndefined:Zu,isDate:Io,isFile:Po,isBlob:Mo,isRegExp:ec,isFunction:iu,isStream:$o,isURLSearchParams:jo,isTypedArray:Ko,isFileList:zo,forEach:Qu,merge:Me,extend:Ho,trim:Uo,stripBOM:Go,inherits:Vo,toFlatObject:Wo,kindOf:me,kindOfTest:xu,endsWith:Zo,toArray:Jo,forEachEntry:Xo,matchAll:Qo,isHTMLForm:Yo,hasOwnProperty:Tt,hasOwnProp:Tt,reduceDescriptors:On,freezeMethods:tc,toObjectSet:nc,toCamelCase:uc,noop:rc,toFiniteNumber:ic,findKey:Sn,global:Tn,isContextDefined:Bn,ALPHABET:Ln,generateString:oc,isSpecCompliantForm:cc,toJSONObject:sc,isAsyncFn:ac,isThenable:lc};function P(u,e,t,n,r){Error.call(this),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack,this.message=u,this.name="AxiosError",e&&(this.code=e),t&&(this.config=t),n&&(this.request=n),r&&(this.response=r)}E.inherits(P,Error,{toJSON:function(){return{message:this.message,name:this.name,description:this.description,number:this.number,fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,config:E.toJSONObject(this.config),code:this.code,status:this.response&&this.response.status?this.response.status:null}}});const Nn=P.prototype,In={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED","ERR_NOT_SUPPORT","ERR_INVALID_URL"].forEach(u=>{In[u]={value:u}});Object.defineProperties(P,In);Object.defineProperty(Nn,"isAxiosError",{value:!0});P.from=(u,e,t,n,r,i)=>{const o=Object.create(Nn);return E.toFlatObject(u,o,function(s){return s!==Error.prototype},c=>c!=="isAxiosError"),P.call(o,u.message,e,t,n,r),o.cause=u,o.name=u.name,i&&Object.assign(o,i),o};const fc=null;function ze(u){return E.isPlainObject(u)||E.isArray(u)}function Pn(u){return E.endsWith(u,"[]")?u.slice(0,-2):u}function Ot(u,e,t){return u?u.concat(e).map(function(r,i){return r=Pn(r),!t&&i?"["+r+"]":r}).join(t?".":""):e}function dc(u){return E.isArray(u)&&!u.some(ze)}const hc=E.toFlatObject(E,{},null,function(e){return/^is[A-Z]/.test(e)});function ge(u,e,t){if(!E.isObject(u))throw new TypeError("target must be an object");e=e||new FormData,t=E.toFlatObject(t,{metaTokens:!0,dots:!1,indexes:!1},!1,function(w,R){return!E.isUndefined(R[w])});const n=t.metaTokens,r=t.visitor||d,i=t.dots,o=t.indexes,s=(t.Blob||typeof Blob<"u"&&Blob)&&E.isSpecCompliantForm(e);if(!E.isFunction(r))throw new TypeError("visitor must be a function");function a(h){if(h===null)return"";if(E.isDate(h))return h.toISOString();if(!s&&E.isBlob(h))throw new P("Blob is not supported. Use a Buffer instead.");return E.isArrayBuffer(h)||E.isTypedArray(h)?s&&typeof Blob=="function"?new Blob([h]):Buffer.from(h):h}function d(h,w,R){let B=h;if(h&&!R&&typeof h=="object"){if(E.endsWith(w,"{}"))w=n?w:w.slice(0,-2),h=JSON.stringify(h);else if(E.isArray(h)&&dc(h)||(E.isFileList(h)||E.endsWith(w,"[]"))&&(B=E.toArray(h)))return w=Pn(w),B.forEach(function(F,T){!(E.isUndefined(F)||F===null)&&e.append(o===!0?Ot([w],T,i):o===null?w:w+"[]",a(F))}),!1}return ze(h)?!0:(e.append(Ot(R,w,i),a(h)),!1)}const l=[],x=Object.assign(hc,{defaultVisitor:d,convertValue:a,isVisitable:ze});function _(h,w){if(!E.isUndefined(h)){if(l.indexOf(h)!==-1)throw Error("Circular reference detected in "+w.join("."));l.push(h),E.forEach(h,function(B,O){(!(E.isUndefined(B)||B===null)&&r.call(e,B,E.isString(O)?O.trim():O,w,x))===!0&&_(B,w?w.concat(O):[O])}),l.pop()}}if(!E.isObject(u))throw new TypeError("data must be an object");return _(u),e}function Lt(u){const e={"!":"%21","'":"%27","(":"%28",")":"%29","~":"%7E","%20":"+","%00":"\0"};return encodeURIComponent(u).replace(/[!'()~]|%20|%00/g,function(n){return e[n]})}function ut(u,e){this._pairs=[],u&&ge(u,this,e)}const Mn=ut.prototype;Mn.append=function(e,t){this._pairs.push([e,t])};Mn.toString=function(e){const t=e?function(n){return e.call(this,n,Lt)}:Lt;return this._pairs.map(function(r){return t(r[0])+"="+t(r[1])},"").join("&")};function pc(u){return encodeURIComponent(u).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function zn(u,e,t){if(!e)return u;const n=t&&t.encode||pc,r=t&&t.serialize;let i;if(r?i=r(e,t):i=E.isURLSearchParams(e)?e.toString():new ut(e,t).toString(n),i){const o=u.indexOf("#");o!==-1&&(u=u.slice(0,o)),u+=(u.indexOf("?")===-1?"?":"&")+i}return u}class Nt{constructor(){this.handlers=[]}use(e,t,n){return this.handlers.push({fulfilled:e,rejected:t,synchronous:n?n.synchronous:!1,runWhen:n?n.runWhen:null}),this.handlers.length-1}eject(e){this.handlers[e]&&(this.handlers[e]=null)}clear(){this.handlers&&(this.handlers=[])}forEach(e){E.forEach(this.handlers,function(n){n!==null&&e(n)})}}const $n={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},bc=typeof URLSearchParams<"u"?URLSearchParams:ut,mc=typeof FormData<"u"?FormData:null,_c=typeof Blob<"u"?Blob:null,xc={isBrowser:!0,classes:{URLSearchParams:bc,FormData:mc,Blob:_c},protocols:["http","https","file","blob","url","data"]},qn=typeof window<"u"&&typeof document<"u",gc=(u=>qn&&["ReactNative","NativeScript","NS"].indexOf(u)<0)(typeof navigator<"u"&&navigator.product),yc=typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope&&typeof self.importScripts=="function",kc=Object.freeze(Object.defineProperty({__proto__:null,hasBrowserEnv:qn,hasStandardBrowserEnv:gc,hasStandardBrowserWebWorkerEnv:yc},Symbol.toStringTag,{value:"Module"})),bu={...kc,...xc};function Ec(u,e){return ge(u,new bu.classes.URLSearchParams,Object.assign({visitor:function(t,n,r,i){return bu.isNode&&E.isBuffer(t)?(this.append(n,t.toString("base64")),!1):i.defaultVisitor.apply(this,arguments)}},e))}function wc(u){return E.matchAll(/\w+|\[(\w*)]/g,u).map(e=>e[0]==="[]"?"":e[1]||e[0])}function Cc(u){const e={},t=Object.keys(u);let n;const r=t.length;let i;for(n=0;n<r;n++)i=t[n],e[i]=u[i];return e}function jn(u){function e(t,n,r,i){let o=t[i++];if(o==="__proto__")return!0;const c=Number.isFinite(+o),s=i>=t.length;return o=!o&&E.isArray(r)?r.length:o,s?(E.hasOwnProp(r,o)?r[o]=[r[o],n]:r[o]=n,!c):((!r[o]||!E.isObject(r[o]))&&(r[o]=[]),e(t,n,r[o],i)&&E.isArray(r[o])&&(r[o]=Cc(r[o])),!c)}if(E.isFormData(u)&&E.isFunction(u.entries)){const t={};return E.forEachEntry(u,(n,r)=>{e(wc(n),r,t,0)}),t}return null}function Dc(u,e,t){if(E.isString(u))try{return(e||JSON.parse)(u),E.trim(u)}catch(n){if(n.name!=="SyntaxError")throw n}return(t||JSON.stringify)(u)}const et={transitional:$n,adapter:["xhr","http"],transformRequest:[function(e,t){const n=t.getContentType()||"",r=n.indexOf("application/json")>-1,i=E.isObject(e);if(i&&E.isHTMLForm(e)&&(e=new FormData(e)),E.isFormData(e))return r?JSON.stringify(jn(e)):e;if(E.isArrayBuffer(e)||E.isBuffer(e)||E.isStream(e)||E.isFile(e)||E.isBlob(e))return e;if(E.isArrayBufferView(e))return e.buffer;if(E.isURLSearchParams(e))return t.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),e.toString();let c;if(i){if(n.indexOf("application/x-www-form-urlencoded")>-1)return Ec(e,this.formSerializer).toString();if((c=E.isFileList(e))||n.indexOf("multipart/form-data")>-1){const s=this.env&&this.env.FormData;return ge(c?{"files[]":e}:e,s&&new s,this.formSerializer)}}return i||r?(t.setContentType("application/json",!1),Dc(e)):e}],transformResponse:[function(e){const t=this.transitional||et.transitional,n=t&&t.forcedJSONParsing,r=this.responseType==="json";if(e&&E.isString(e)&&(n&&!this.responseType||r)){const o=!(t&&t.silentJSONParsing)&&r;try{return JSON.parse(e)}catch(c){if(o)throw c.name==="SyntaxError"?P.from(c,P.ERR_BAD_RESPONSE,this,null,this.response):c}}return e}],timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:bu.classes.FormData,Blob:bu.classes.Blob},validateStatus:function(e){return e>=200&&e<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};E.forEach(["delete","get","head","post","put","patch"],u=>{et.headers[u]={}});const tt=et,Ac=E.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]),Fc=u=>{const e={};let t,n,r;return u&&u.split(`
`).forEach(function(o){r=o.indexOf(":"),t=o.substring(0,r).trim().toLowerCase(),n=o.substring(r+1).trim(),!(!t||e[t]&&Ac[t])&&(t==="set-cookie"?e[t]?e[t].push(n):e[t]=[n]:e[t]=e[t]?e[t]+", "+n:n)}),e},It=Symbol("internals");function qu(u){return u&&String(u).trim().toLowerCase()}function oe(u){return u===!1||u==null?u:E.isArray(u)?u.map(oe):String(u)}function vc(u){const e=Object.create(null),t=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;let n;for(;n=t.exec(u);)e[n[1]]=n[2];return e}const Rc=u=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(u.trim());function Se(u,e,t,n,r){if(E.isFunction(n))return n.call(this,e,t);if(r&&(e=t),!!E.isString(e)){if(E.isString(n))return e.indexOf(n)!==-1;if(E.isRegExp(n))return n.test(e)}}function Sc(u){return u.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(e,t,n)=>t.toUpperCase()+n)}function Tc(u,e){const t=E.toCamelCase(" "+e);["get","set","has"].forEach(n=>{Object.defineProperty(u,n+t,{value:function(r,i,o){return this[n].call(this,e,r,i,o)},configurable:!0})})}class ye{constructor(e){e&&this.set(e)}set(e,t,n){const r=this;function i(c,s,a){const d=qu(s);if(!d)throw new Error("header name must be a non-empty string");const l=E.findKey(r,d);(!l||r[l]===void 0||a===!0||a===void 0&&r[l]!==!1)&&(r[l||s]=oe(c))}const o=(c,s)=>E.forEach(c,(a,d)=>i(a,d,s));return E.isPlainObject(e)||e instanceof this.constructor?o(e,t):E.isString(e)&&(e=e.trim())&&!Rc(e)?o(Fc(e),t):e!=null&&i(t,e,n),this}get(e,t){if(e=qu(e),e){const n=E.findKey(this,e);if(n){const r=this[n];if(!t)return r;if(t===!0)return vc(r);if(E.isFunction(t))return t.call(this,r,n);if(E.isRegExp(t))return t.exec(r);throw new TypeError("parser must be boolean|regexp|function")}}}has(e,t){if(e=qu(e),e){const n=E.findKey(this,e);return!!(n&&this[n]!==void 0&&(!t||Se(this,this[n],n,t)))}return!1}delete(e,t){const n=this;let r=!1;function i(o){if(o=qu(o),o){const c=E.findKey(n,o);c&&(!t||Se(n,n[c],c,t))&&(delete n[c],r=!0)}}return E.isArray(e)?e.forEach(i):i(e),r}clear(e){const t=Object.keys(this);let n=t.length,r=!1;for(;n--;){const i=t[n];(!e||Se(this,this[i],i,e,!0))&&(delete this[i],r=!0)}return r}normalize(e){const t=this,n={};return E.forEach(this,(r,i)=>{const o=E.findKey(n,i);if(o){t[o]=oe(r),delete t[i];return}const c=e?Sc(i):String(i).trim();c!==i&&delete t[i],t[c]=oe(r),n[c]=!0}),this}concat(...e){return this.constructor.concat(this,...e)}toJSON(e){const t=Object.create(null);return E.forEach(this,(n,r)=>{n!=null&&n!==!1&&(t[r]=e&&E.isArray(n)?n.join(", "):n)}),t}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([e,t])=>e+": "+t).join(`
`)}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(e){return e instanceof this?e:new this(e)}static concat(e,...t){const n=new this(e);return t.forEach(r=>n.set(r)),n}static accessor(e){const n=(this[It]=this[It]={accessors:{}}).accessors,r=this.prototype;function i(o){const c=qu(o);n[c]||(Tc(r,o),n[c]=!0)}return E.isArray(e)?e.forEach(i):i(e),this}}ye.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]);E.reduceDescriptors(ye.prototype,({value:u},e)=>{let t=e[0].toUpperCase()+e.slice(1);return{get:()=>u,set(n){this[t]=n}}});E.freezeMethods(ye);const yu=ye;function Te(u,e){const t=this||tt,n=e||t,r=yu.from(n.headers);let i=n.data;return E.forEach(u,function(c){i=c.call(t,i,r.normalize(),e?e.status:void 0)}),r.normalize(),i}function Un(u){return!!(u&&u.__CANCEL__)}function Yu(u,e,t){P.call(this,u??"canceled",P.ERR_CANCELED,e,t),this.name="CanceledError"}E.inherits(Yu,P,{__CANCEL__:!0});function Bc(u,e,t){const n=t.config.validateStatus;!t.status||!n||n(t.status)?u(t):e(new P("Request failed with status code "+t.status,[P.ERR_BAD_REQUEST,P.ERR_BAD_RESPONSE][Math.floor(t.status/100)-4],t.config,t.request,t))}const Oc=bu.hasStandardBrowserEnv?{write(u,e,t,n,r,i){const o=[u+"="+encodeURIComponent(e)];E.isNumber(t)&&o.push("expires="+new Date(t).toGMTString()),E.isString(n)&&o.push("path="+n),E.isString(r)&&o.push("domain="+r),i===!0&&o.push("secure"),document.cookie=o.join("; ")},read(u){const e=document.cookie.match(new RegExp("(^|;\\s*)("+u+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove(u){this.write(u,"",Date.now()-864e5)}}:{write(){},read(){return null},remove(){}};function Lc(u){return/^([a-z][a-z\d+\-.]*:)?\/\//i.test(u)}function Nc(u,e){return e?u.replace(/\/?\/$/,"")+"/"+e.replace(/^\/+/,""):u}function Hn(u,e){return u&&!Lc(e)?Nc(u,e):e}const Ic=bu.hasStandardBrowserEnv?function(){const e=/(msie|trident)/i.test(navigator.userAgent),t=document.createElement("a");let n;function r(i){let o=i;return e&&(t.setAttribute("href",o),o=t.href),t.setAttribute("href",o),{href:t.href,protocol:t.protocol?t.protocol.replace(/:$/,""):"",host:t.host,search:t.search?t.search.replace(/^\?/,""):"",hash:t.hash?t.hash.replace(/^#/,""):"",hostname:t.hostname,port:t.port,pathname:t.pathname.charAt(0)==="/"?t.pathname:"/"+t.pathname}}return n=r(window.location.href),function(o){const c=E.isString(o)?r(o):o;return c.protocol===n.protocol&&c.host===n.host}}():function(){return function(){return!0}}();function Pc(u){const e=/^([-+\w]{1,25})(:?\/\/|:)/.exec(u);return e&&e[1]||""}function Mc(u,e){u=u||10;const t=new Array(u),n=new Array(u);let r=0,i=0,o;return e=e!==void 0?e:1e3,function(s){const a=Date.now(),d=n[i];o||(o=a),t[r]=s,n[r]=a;let l=i,x=0;for(;l!==r;)x+=t[l++],l=l%u;if(r=(r+1)%u,r===i&&(i=(i+1)%u),a-o<e)return;const _=d&&a-d;return _?Math.round(x*1e3/_):void 0}}function Pt(u,e){let t=0;const n=Mc(50,250);return r=>{const i=r.loaded,o=r.lengthComputable?r.total:void 0,c=i-t,s=n(c),a=i<=o;t=i;const d={loaded:i,total:o,progress:o?i/o:void 0,bytes:c,rate:s||void 0,estimated:s&&o&&a?(o-i)/s:void 0,event:r};d[e?"download":"upload"]=!0,u(d)}}const zc=typeof XMLHttpRequest<"u",$c=zc&&function(u){return new Promise(function(t,n){let r=u.data;const i=yu.from(u.headers).normalize();let{responseType:o,withXSRFToken:c}=u,s;function a(){u.cancelToken&&u.cancelToken.unsubscribe(s),u.signal&&u.signal.removeEventListener("abort",s)}let d;if(E.isFormData(r)){if(bu.hasStandardBrowserEnv||bu.hasStandardBrowserWebWorkerEnv)i.setContentType(!1);else if((d=i.getContentType())!==!1){const[w,...R]=d?d.split(";").map(B=>B.trim()).filter(Boolean):[];i.setContentType([w||"multipart/form-data",...R].join("; "))}}let l=new XMLHttpRequest;if(u.auth){const w=u.auth.username||"",R=u.auth.password?unescape(encodeURIComponent(u.auth.password)):"";i.set("Authorization","Basic "+btoa(w+":"+R))}const x=Hn(u.baseURL,u.url);l.open(u.method.toUpperCase(),zn(x,u.params,u.paramsSerializer),!0),l.timeout=u.timeout;function _(){if(!l)return;const w=yu.from("getAllResponseHeaders"in l&&l.getAllResponseHeaders()),B={data:!o||o==="text"||o==="json"?l.responseText:l.response,status:l.status,statusText:l.statusText,headers:w,config:u,request:l};Bc(function(F){t(F),a()},function(F){n(F),a()},B),l=null}if("onloadend"in l?l.onloadend=_:l.onreadystatechange=function(){!l||l.readyState!==4||l.status===0&&!(l.responseURL&&l.responseURL.indexOf("file:")===0)||setTimeout(_)},l.onabort=function(){l&&(n(new P("Request aborted",P.ECONNABORTED,u,l)),l=null)},l.onerror=function(){n(new P("Network Error",P.ERR_NETWORK,u,l)),l=null},l.ontimeout=function(){let R=u.timeout?"timeout of "+u.timeout+"ms exceeded":"timeout exceeded";const B=u.transitional||$n;u.timeoutErrorMessage&&(R=u.timeoutErrorMessage),n(new P(R,B.clarifyTimeoutError?P.ETIMEDOUT:P.ECONNABORTED,u,l)),l=null},bu.hasStandardBrowserEnv&&(c&&E.isFunction(c)&&(c=c(u)),c||c!==!1&&Ic(x))){const w=u.xsrfHeaderName&&u.xsrfCookieName&&Oc.read(u.xsrfCookieName);w&&i.set(u.xsrfHeaderName,w)}r===void 0&&i.setContentType(null),"setRequestHeader"in l&&E.forEach(i.toJSON(),function(R,B){l.setRequestHeader(B,R)}),E.isUndefined(u.withCredentials)||(l.withCredentials=!!u.withCredentials),o&&o!=="json"&&(l.responseType=u.responseType),typeof u.onDownloadProgress=="function"&&l.addEventListener("progress",Pt(u.onDownloadProgress,!0)),typeof u.onUploadProgress=="function"&&l.upload&&l.upload.addEventListener("progress",Pt(u.onUploadProgress)),(u.cancelToken||u.signal)&&(s=w=>{l&&(n(!w||w.type?new Yu(null,u,l):w),l.abort(),l=null)},u.cancelToken&&u.cancelToken.subscribe(s),u.signal&&(u.signal.aborted?s():u.signal.addEventListener("abort",s)));const h=Pc(x);if(h&&bu.protocols.indexOf(h)===-1){n(new P("Unsupported protocol "+h+":",P.ERR_BAD_REQUEST,u));return}l.send(r||null)})},$e={http:fc,xhr:$c};E.forEach($e,(u,e)=>{if(u){try{Object.defineProperty(u,"name",{value:e})}catch{}Object.defineProperty(u,"adapterName",{value:e})}});const Mt=u=>`- ${u}`,qc=u=>E.isFunction(u)||u===null||u===!1,Gn={getAdapter:u=>{u=E.isArray(u)?u:[u];const{length:e}=u;let t,n;const r={};for(let i=0;i<e;i++){t=u[i];let o;if(n=t,!qc(t)&&(n=$e[(o=String(t)).toLowerCase()],n===void 0))throw new P(`Unknown adapter '${o}'`);if(n)break;r[o||"#"+i]=n}if(!n){const i=Object.entries(r).map(([c,s])=>`adapter ${c} `+(s===!1?"is not supported by the environment":"is not available in the build"));let o=e?i.length>1?`since :
`+i.map(Mt).join(`
`):" "+Mt(i[0]):"as no adapter specified";throw new P("There is no suitable adapter to dispatch the request "+o,"ERR_NOT_SUPPORT")}return n},adapters:$e};function Be(u){if(u.cancelToken&&u.cancelToken.throwIfRequested(),u.signal&&u.signal.aborted)throw new Yu(null,u)}function zt(u){return Be(u),u.headers=yu.from(u.headers),u.data=Te.call(u,u.transformRequest),["post","put","patch"].indexOf(u.method)!==-1&&u.headers.setContentType("application/x-www-form-urlencoded",!1),Gn.getAdapter(u.adapter||tt.adapter)(u).then(function(n){return Be(u),n.data=Te.call(u,u.transformResponse,n),n.headers=yu.from(n.headers),n},function(n){return Un(n)||(Be(u),n&&n.response&&(n.response.data=Te.call(u,u.transformResponse,n.response),n.response.headers=yu.from(n.response.headers))),Promise.reject(n)})}const $t=u=>u instanceof yu?u.toJSON():u;function Pu(u,e){e=e||{};const t={};function n(a,d,l){return E.isPlainObject(a)&&E.isPlainObject(d)?E.merge.call({caseless:l},a,d):E.isPlainObject(d)?E.merge({},d):E.isArray(d)?d.slice():d}function r(a,d,l){if(E.isUndefined(d)){if(!E.isUndefined(a))return n(void 0,a,l)}else return n(a,d,l)}function i(a,d){if(!E.isUndefined(d))return n(void 0,d)}function o(a,d){if(E.isUndefined(d)){if(!E.isUndefined(a))return n(void 0,a)}else return n(void 0,d)}function c(a,d,l){if(l in e)return n(a,d);if(l in u)return n(void 0,a)}const s={url:i,method:i,data:i,baseURL:o,transformRequest:o,transformResponse:o,paramsSerializer:o,timeout:o,timeoutMessage:o,withCredentials:o,withXSRFToken:o,adapter:o,responseType:o,xsrfCookieName:o,xsrfHeaderName:o,onUploadProgress:o,onDownloadProgress:o,decompress:o,maxContentLength:o,maxBodyLength:o,beforeRedirect:o,transport:o,httpAgent:o,httpsAgent:o,cancelToken:o,socketPath:o,responseEncoding:o,validateStatus:c,headers:(a,d)=>r($t(a),$t(d),!0)};return E.forEach(Object.keys(Object.assign({},u,e)),function(d){const l=s[d]||r,x=l(u[d],e[d],d);E.isUndefined(x)&&l!==c||(t[d]=x)}),t}const Vn="1.6.7",nt={};["object","boolean","number","function","string","symbol"].forEach((u,e)=>{nt[u]=function(n){return typeof n===u||"a"+(e<1?"n ":" ")+u}});const qt={};nt.transitional=function(e,t,n){function r(i,o){return"[Axios v"+Vn+"] Transitional option '"+i+"'"+o+(n?". "+n:"")}return(i,o,c)=>{if(e===!1)throw new P(r(o," has been removed"+(t?" in "+t:"")),P.ERR_DEPRECATED);return t&&!qt[o]&&(qt[o]=!0,console.warn(r(o," has been deprecated since v"+t+" and will be removed in the near future"))),e?e(i,o,c):!0}};function jc(u,e,t){if(typeof u!="object")throw new P("options must be an object",P.ERR_BAD_OPTION_VALUE);const n=Object.keys(u);let r=n.length;for(;r-- >0;){const i=n[r],o=e[i];if(o){const c=u[i],s=c===void 0||o(c,i,u);if(s!==!0)throw new P("option "+i+" must be "+s,P.ERR_BAD_OPTION_VALUE);continue}if(t!==!0)throw new P("Unknown option "+i,P.ERR_BAD_OPTION)}}const qe={assertOptions:jc,validators:nt},wu=qe.validators;class fe{constructor(e){this.defaults=e,this.interceptors={request:new Nt,response:new Nt}}async request(e,t){try{return await this._request(e,t)}catch(n){if(n instanceof Error){let r;Error.captureStackTrace?Error.captureStackTrace(r={}):r=new Error;const i=r.stack?r.stack.replace(/^.+\n/,""):"";n.stack?i&&!String(n.stack).endsWith(i.replace(/^.+\n.+\n/,""))&&(n.stack+=`
`+i):n.stack=i}throw n}}_request(e,t){typeof e=="string"?(t=t||{},t.url=e):t=e||{},t=Pu(this.defaults,t);const{transitional:n,paramsSerializer:r,headers:i}=t;n!==void 0&&qe.assertOptions(n,{silentJSONParsing:wu.transitional(wu.boolean),forcedJSONParsing:wu.transitional(wu.boolean),clarifyTimeoutError:wu.transitional(wu.boolean)},!1),r!=null&&(E.isFunction(r)?t.paramsSerializer={serialize:r}:qe.assertOptions(r,{encode:wu.function,serialize:wu.function},!0)),t.method=(t.method||this.defaults.method||"get").toLowerCase();let o=i&&E.merge(i.common,i[t.method]);i&&E.forEach(["delete","get","head","post","put","patch","common"],h=>{delete i[h]}),t.headers=yu.concat(o,i);const c=[];let s=!0;this.interceptors.request.forEach(function(w){typeof w.runWhen=="function"&&w.runWhen(t)===!1||(s=s&&w.synchronous,c.unshift(w.fulfilled,w.rejected))});const a=[];this.interceptors.response.forEach(function(w){a.push(w.fulfilled,w.rejected)});let d,l=0,x;if(!s){const h=[zt.bind(this),void 0];for(h.unshift.apply(h,c),h.push.apply(h,a),x=h.length,d=Promise.resolve(t);l<x;)d=d.then(h[l++],h[l++]);return d}x=c.length;let _=t;for(l=0;l<x;){const h=c[l++],w=c[l++];try{_=h(_)}catch(R){w.call(this,R);break}}try{d=zt.call(this,_)}catch(h){return Promise.reject(h)}for(l=0,x=a.length;l<x;)d=d.then(a[l++],a[l++]);return d}getUri(e){e=Pu(this.defaults,e);const t=Hn(e.baseURL,e.url);return zn(t,e.params,e.paramsSerializer)}}E.forEach(["delete","get","head","options"],function(e){fe.prototype[e]=function(t,n){return this.request(Pu(n||{},{method:e,url:t,data:(n||{}).data}))}});E.forEach(["post","put","patch"],function(e){function t(n){return function(i,o,c){return this.request(Pu(c||{},{method:e,headers:n?{"Content-Type":"multipart/form-data"}:{},url:i,data:o}))}}fe.prototype[e]=t(),fe.prototype[e+"Form"]=t(!0)});const ce=fe;class rt{constructor(e){if(typeof e!="function")throw new TypeError("executor must be a function.");let t;this.promise=new Promise(function(i){t=i});const n=this;this.promise.then(r=>{if(!n._listeners)return;let i=n._listeners.length;for(;i-- >0;)n._listeners[i](r);n._listeners=null}),this.promise.then=r=>{let i;const o=new Promise(c=>{n.subscribe(c),i=c}).then(r);return o.cancel=function(){n.unsubscribe(i)},o},e(function(i,o,c){n.reason||(n.reason=new Yu(i,o,c),t(n.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(e){if(this.reason){e(this.reason);return}this._listeners?this._listeners.push(e):this._listeners=[e]}unsubscribe(e){if(!this._listeners)return;const t=this._listeners.indexOf(e);t!==-1&&this._listeners.splice(t,1)}static source(){let e;return{token:new rt(function(r){e=r}),cancel:e}}}const Uc=rt;function Hc(u){return function(t){return u.apply(null,t)}}function Gc(u){return E.isObject(u)&&u.isAxiosError===!0}const je={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511};Object.entries(je).forEach(([u,e])=>{je[e]=u});const Vc=je;function Wn(u){const e=new ce(u),t=Fn(ce.prototype.request,e);return E.extend(t,ce.prototype,e,{allOwnKeys:!0}),E.extend(t,e,null,{allOwnKeys:!0}),t.create=function(r){return Wn(Pu(u,r))},t}const Z=Wn(tt);Z.Axios=ce;Z.CanceledError=Yu;Z.CancelToken=Uc;Z.isCancel=Un;Z.VERSION=Vn;Z.toFormData=ge;Z.AxiosError=P;Z.Cancel=Z.CanceledError;Z.all=function(e){return Promise.all(e)};Z.spread=Hc;Z.isAxiosError=Gc;Z.mergeConfig=Pu;Z.AxiosHeaders=yu;Z.formToJSON=u=>jn(E.isHTMLForm(u)?new FormData(u):u);Z.getAdapter=Gn.getAdapter;Z.HttpStatusCode=Vc;Z.default=Z;const Wc=async()=>{const u=await ku(()=>import("./config.DY70oKIP.js"),__vite__mapDeps([]),import.meta.url),e=await $fetch("/api/getReadme").catch(r=>Z.get(u.GITHUB_README_URL).then(i=>i.data)),n=ou("commonmark",{linkify:!0,typographer:!0}).render(e);return p($,null,[p("div",{className:"whitespace-pre-wrap"},[p("span",null,["Displaying GitHub README..."]),p("br",null,null),p("div",{innerHTML:n},null)])])},Zc=async()=>{const u=await ku(()=>import("./config.DY70oKIP.js"),__vite__mapDeps([]),import.meta.url),e=await $fetch("/api/getProjects").catch(t=>Z.get(u.GITHUB_REPOSITORIES_URL).then(n=>n.data));return p($,null,[p("div",null,[p("span",{className:"text-light-foreground dark:text-dark-foreground"},[gu("GitHub Projects: ")]),p("ul",null,[e.map(t=>p("li",null,[p("span",{className:"text-light-foreground dark:text-dark-foreground "},[t.name,gu(" - "),p("a",{className:"text-light-blue dark:text-dark-blue underline flex-grow-0",href:t.html_url,target:"_blank"},[t.html_url])])]))])])])},Jc={path:"/",watch:!0,decode:u=>rr(decodeURIComponent(u)),encode:u=>encodeURIComponent(typeof u=="string"?u:JSON.stringify(u))};function it(u,e){var s;const t={...Jc,...e},n=jt(t)||{};let r;t.maxAge!==void 0?r=t.maxAge*1e3:t.expires&&(r=t.expires.getTime()-Date.now());const i=r!==void 0&&r<=0,o=lu(i?void 0:n[u]??((s=t.default)==null?void 0:s.call(t))),c=r&&!i?Qc(o,r):K(o);{const a=typeof BroadcastChannel>"u"?null:new BroadcastChannel(`nuxt:cookies:${u}`),d=()=>{t.readonly||kr(c.value,n[u])||(Xc(u,c.value,t),n[u]=lu(c.value),a==null||a.postMessage({value:t.encode(c.value)}))},l=_=>{var w;const h=_.refresh?(w=jt(t))==null?void 0:w[u]:t.decode(_.value);x=!0,n[u]=c.value=h,ir(()=>{x=!1})};let x=!1;Kt()&&Xt(()=>{x=!0,d(),a==null||a.close()}),a&&(a.onmessage=({data:_})=>l(_)),t.watch?tr(c,()=>{x||d()},{deep:t.watch!=="shallow"}):d()}return c}function jt(u={}){return pr(document.cookie,u)}function Kc(u,e,t={}){return e==null?at(u,e,{...t,maxAge:-1}):at(u,e,t)}function Xc(u,e,t={}){document.cookie=Kc(u,e,t)}const Ut=2147483647;function Qc(u,e){let t,n=0;return Kt()&&Xt(()=>{clearTimeout(t)}),nr((r,i)=>{function o(){clearTimeout(t);const c=e-n,s=c<Ut?c:Ut;t=setTimeout(()=>{if(n+=s,n<e)return o();u=void 0,i()},s)}return{get(){return r(),u},set(c){o(),u=c,i()}}})}function Yc(u){return u&&u.__esModule&&Object.prototype.hasOwnProperty.call(u,"default")?u.default:u}var Zn={exports:{}};(function(u){const e=(()=>{const o={},c={font:"Standard",fontPath:"./fonts"};function s(m,g){let f={},b,y,k,A,D=[[16384,"vLayout",2],[8192,"vLayout",1],[4096,"vRule5",!0],[2048,"vRule4",!0],[1024,"vRule3",!0],[512,"vRule2",!0],[256,"vRule1",!0],[128,"hLayout",2],[64,"hLayout",1],[32,"hRule6",!0],[16,"hRule5",!0],[8,"hRule4",!0],[4,"hRule3",!0],[2,"hRule2",!0],[1,"hRule1",!0]];for(b=g!==null?g:m,y=0,k=D.length;y<k;)A=D[y],b>=A[0]?(b=b-A[0],f[A[1]]=typeof f[A[1]]>"u"?A[2]:f[A[1]]):A[1]!=="vLayout"&&A[1]!=="hLayout"&&(f[A[1]]=!1),y++;return typeof f.hLayout>"u"?m===0?f.hLayout=1:m===-1?f.hLayout=0:f.hRule1||f.hRule2||f.hRule3||f.hRule4||f.hRule5||f.hRule6?f.hLayout=3:f.hLayout=2:f.hLayout===2&&(f.hRule1||f.hRule2||f.hRule3||f.hRule4||f.hRule5||f.hRule6)&&(f.hLayout=3),typeof f.vLayout>"u"?f.vRule1||f.vRule2||f.vRule3||f.vRule4||f.vRule5?f.vLayout=3:f.vLayout=0:f.vLayout===2&&(f.vRule1||f.vRule2||f.vRule3||f.vRule4||f.vRule5)&&(f.vLayout=3),f}function a(m,g,f){return m===g&&m!==f?m:!1}function d(m,g){let f="|/\\[]{}()<>";if(m==="_"){if(f.indexOf(g)!==-1)return g}else if(g==="_"&&f.indexOf(m)!==-1)return m;return!1}function l(m,g){let f="| /\\ [] {} () <>",b=f.indexOf(m),y=f.indexOf(g);if(b!==-1&&y!==-1&&b!==y&&Math.abs(b-y)!==1){const k=Math.max(b,y),A=k+1;return f.substring(k,A)}return!1}function x(m,g){let f="[] {} ()",b=f.indexOf(m),y=f.indexOf(g);return b!==-1&&y!==-1&&Math.abs(b-y)<=1?"|":!1}function _(m,g){let f="/\\ \\/ ><",b={0:"|",3:"Y",6:"X"},y=f.indexOf(m),k=f.indexOf(g);return y!==-1&&k!==-1&&k-y===1?b[y]:!1}function h(m,g,f){return m===f&&g===f?f:!1}function w(m,g){return m===g?m:!1}function R(m,g){let f="|/\\[]{}()<>";if(m==="_"){if(f.indexOf(g)!==-1)return g}else if(g==="_"&&f.indexOf(m)!==-1)return m;return!1}function B(m,g){let f="| /\\ [] {} () <>",b=f.indexOf(m),y=f.indexOf(g);if(b!==-1&&y!==-1&&b!==y&&Math.abs(b-y)!==1){const k=Math.max(b,y),A=k+1;return f.substring(k,A)}return!1}function O(m,g){return m==="-"&&g==="_"||m==="_"&&g==="-"?"=":!1}function F(m,g){return m==="|"&&g==="|"?"|":!1}function T(m,g,f){return g===" "||g===""||g===f&&m!==" "?m:g}function v(m,g,f){if(f.fittingRules.vLayout===0)return"invalid";let b,y=Math.min(m.length,g.length),k,A,D=!1,C;if(y===0)return"invalid";for(b=0;b<y;b++)if(k=m.substring(b,b+1),A=g.substring(b,b+1),k!==" "&&A!==" "){if(f.fittingRules.vLayout===1)return"invalid";if(f.fittingRules.vLayout===2)return"end";if(F(k,A)){D=D||!1;continue}if(C=!1,C=f.fittingRules.vRule1?w(k,A):C,C=!C&&f.fittingRules.vRule2?R(k,A):C,C=!C&&f.fittingRules.vRule3?B(k,A):C,C=!C&&f.fittingRules.vRule4?O(k,A):C,D=!0,!C)return"invalid"}return D?"end":"valid"}function M(m,g,f){let b=m.length,y=m.length;g.length;let k,A,D,C=1,S,H,q;for(;C<=b;){for(k=m.slice(Math.max(0,y-C),y),A=g.slice(0,Math.min(b,C)),D=A.length,q="",S=0;S<D;S++)if(H=v(k[S],A[S],f),H==="end")q=H;else if(H==="invalid"){q=H;break}else q===""&&(q="valid");if(q==="invalid"){C--;break}if(q==="end")break;q==="valid"&&C++}return Math.min(b,C)}function V(m,g,f){let b,y=Math.min(m.length,g.length),k,A,D="",C;for(b=0;b<y;b++)k=m.substring(b,b+1),A=g.substring(b,b+1),k!==" "&&A!==" "?f.fittingRules.vLayout===1||f.fittingRules.vLayout===2?D+=T(k,A):(C=!1,C=f.fittingRules.vRule5?F(k,A):C,C=!C&&f.fittingRules.vRule1?w(k,A):C,C=!C&&f.fittingRules.vRule2?R(k,A):C,C=!C&&f.fittingRules.vRule3?B(k,A):C,C=!C&&f.fittingRules.vRule4?O(k,A):C,D+=C):D+=T(k,A);return D}function su(m,g,f,b){let y=m.length,k=g.length,A=m.slice(0,Math.max(0,y-f)),D=m.slice(Math.max(0,y-f),y),C=g.slice(0,Math.min(f,k)),S,H,q,z=[],j,tu=[];for(H=D.length,S=0;S<H;S++)S>=k?q=D[S]:q=V(D[S],C[S],b),z.push(q);return j=g.slice(Math.min(f,k),k),tu.concat(A,z,j)}function au(m,g){let f,b=m.length,y="";for(f=0;f<g;f++)y+=" ";for(f=0;f<b;f++)m[f]+=y}function Tu(m,g,f){let b=m[0].length,y=g[0].length,k;return b>y?au(g,b-y):y>b&&au(m,y-b),k=M(m,g,f),su(m,g,k,f)}function $u(m,g,f){if(f.fittingRules.hLayout===0)return 0;let b,y=m.length,k=g.length,A=y,D=1,C=!1,S=!1,H,q,z,j;if(y===0)return 0;u:for(;D<=A;){const tu=y-D;for(H=m.substring(tu,tu+D),q=g.substring(0,Math.min(D,k)),b=0;b<Math.min(D,k);b++)if(z=H.substring(b,b+1),j=q.substring(b,b+1),z!==" "&&j!==" "){if(f.fittingRules.hLayout===1){D=D-1;break u}else if(f.fittingRules.hLayout===2){(z===f.hardBlank||j===f.hardBlank)&&(D=D-1);break u}else if(C=!0,S=!1,S=f.fittingRules.hRule1?a(z,j,f.hardBlank):S,S=!S&&f.fittingRules.hRule2?d(z,j,f.hardBlank):S,S=!S&&f.fittingRules.hRule3?l(z,j,f.hardBlank):S,S=!S&&f.fittingRules.hRule4?x(z,j,f.hardBlank):S,S=!S&&f.fittingRules.hRule5?_(z,j,f.hardBlank):S,S=!S&&f.fittingRules.hRule6?h(z,j,f.hardBlank):S,!S){D=D-1;break u}}if(C)break;D++}return Math.min(A,D)}function Eu(m,g,f,b){let y,k,A=[],D,C,S,H,q,z,j,tu;for(y=0;y<b.height;y++){j=m[y],tu=g[y],q=j.length,z=tu.length,D=q-f,C=j.substr(0,Math.max(0,D)),S="";const st=Math.max(0,q-f);var Bu=j.substring(st,st+f),ue=tu.substring(0,Math.min(f,z));for(k=0;k<f;k++){var W=k<q?Bu.substring(k,k+1):" ",Q=k<z?ue.substring(k,k+1):" ";if(W!==" "&&Q!==" ")if(b.fittingRules.hLayout===1)S+=T(W,Q,b.hardBlank);else if(b.fittingRules.hLayout===2)S+=T(W,Q,b.hardBlank);else{var G="";G=!G&&b.fittingRules.hRule1?a(W,Q,b.hardBlank):G,G=!G&&b.fittingRules.hRule2?d(W,Q,b.hardBlank):G,G=!G&&b.fittingRules.hRule3?l(W,Q,b.hardBlank):G,G=!G&&b.fittingRules.hRule4?x(W,Q,b.hardBlank):G,G=!G&&b.fittingRules.hRule5?_(W,Q,b.hardBlank):G,G=!G&&b.fittingRules.hRule6?h(W,Q,b.hardBlank):G,G=G||T(W,Q,b.hardBlank),S+=G}else S+=T(W,Q,b.hardBlank)}f>=z?H="":H=tu.substring(f,f+Math.max(0,z-f)),A[y]=C+S+H}return A}function L(m){let g=[],f;for(f=0;f<m;f++)g[f]="";return g}const I=function(m){return Math.max.apply(Math,m.map(function(g,f){return g.length}))};function N(m,g,f){return m.reduce(function(b,y){return Eu(b,y.fig,y.overlap,f)},L(g))}function vu(m,g,f){const b={};for(let y=m.length;--y;){let k=N(m.slice(0,y),g,f);if(I(k)<=f.width){b.outputFigText=k,y<m.length?b.chars=m.slice(y):b.chars=[];break}}return b}function ke(m,g,f){let b,y,k=0,A,D,C,S=f.height,H=[],q,z,j=[],tu,Bu,ue,W,Q;for(D=L(S),f.width>0&&f.whitespaceBreak&&(z={chars:[],overlap:k}),f.printDirection===1&&(m=m.split("").reverse().join("")),C=m.length,b=0;b<C;b++)if(tu=m.substring(b,b+1),Bu=tu.match(/\s/),y=g[tu.charCodeAt(0)],W=null,y){if(f.fittingRules.hLayout!==0){for(k=1e4,A=0;A<f.height;A++)k=Math.min(k,$u(D[A],y[A],f));k=k===1e4?0:k}if(f.width>0&&(f.whitespaceBreak?(ue=N(z.chars.concat([{fig:y,overlap:k}]),S,f),W=N(j.concat([{fig:ue,overlap:z.overlap}]),S,f),q=I(W)):(W=Eu(D,y,k,f),q=I(W)),q>=f.width&&b>0&&(f.whitespaceBreak?(D=N(j.slice(0,-1),S,f),j.length>1&&(H.push(D),D=L(S)),j=[]):(H.push(D),D=L(S)))),f.width>0&&f.whitespaceBreak&&((!Bu||b===C-1)&&z.chars.push({fig:y,overlap:k}),Bu||b===C-1)){for(Q=null;W=N(z.chars,S,f),q=I(W),q>=f.width;)Q=vu(z.chars,S,f),z={chars:Q.chars},H.push(Q.outputFigText);q>0&&(Q?j.push({fig:W,overlap:1}):j.push({fig:W,overlap:z.overlap})),Bu&&(j.push({fig:y,overlap:k}),D=L(S)),b===C-1&&(D=N(j,S,f)),z={chars:[],overlap:k};continue}D=Eu(D,y,k,f)}return I(D)>0&&H.push(D),f.showHardBlanks!==!0&&H.forEach(function(G){for(C=G.length,A=0;A<C;A++)G[A]=G[A].replace(new RegExp("\\"+f.hardBlank,"g")," ")}),H}const Kn=function(m,g){let f=["hLayout","hRule1","hRule2","hRule3","hRule4","hRule5","hRule6"],b={},y;if(m==="default")for(y=0;y<f.length;y++)b[f[y]]=g.fittingRules[f[y]];else if(m==="full")b={hLayout:0,hRule1:!1,hRule2:!1,hRule3:!1,hRule4:!1,hRule5:!1,hRule6:!1};else if(m==="fitted")b={hLayout:1,hRule1:!1,hRule2:!1,hRule3:!1,hRule4:!1,hRule5:!1,hRule6:!1};else if(m==="controlled smushing")b={hLayout:3,hRule1:!0,hRule2:!0,hRule3:!0,hRule4:!0,hRule5:!0,hRule6:!0};else if(m==="universal smushing")b={hLayout:2,hRule1:!1,hRule2:!1,hRule3:!1,hRule4:!1,hRule5:!1,hRule6:!1};else return;return b},Xn=function(m,g){let f=["vLayout","vRule1","vRule2","vRule3","vRule4","vRule5"],b={},y;if(m==="default")for(y=0;y<f.length;y++)b[f[y]]=g.fittingRules[f[y]];else if(m==="full")b={vLayout:0,vRule1:!1,vRule2:!1,vRule3:!1,vRule4:!1,vRule5:!1};else if(m==="fitted")b={vLayout:1,vRule1:!1,vRule2:!1,vRule3:!1,vRule4:!1,vRule5:!1};else if(m==="controlled smushing")b={vLayout:3,vRule1:!0,vRule2:!0,vRule3:!0,vRule4:!0,vRule5:!0};else if(m==="universal smushing")b={vLayout:2,vRule1:!1,vRule2:!1,vRule3:!1,vRule4:!1,vRule5:!1};else return;return b},ot=function(m,g,f){f=f.replace(/\r\n/g,`
`).replace(/\r/g,`
`);let b=f.split(`
`),y=[],k,A,D;for(A=b.length,k=0;k<A;k++)y=y.concat(ke(b[k],o[m],g));for(A=y.length,D=y[0],k=1;k<A;k++)D=Tu(D,y[k],g);return D?D.join(`
`):""};function ct(m,g){let f=JSON.parse(JSON.stringify(m)),b,y;if(typeof g.horizontalLayout<"u"){b=Kn(g.horizontalLayout,m);for(y in b)b.hasOwnProperty(y)&&(f.fittingRules[y]=b[y])}if(typeof g.verticalLayout<"u"){b=Xn(g.verticalLayout,m);for(y in b)b.hasOwnProperty(y)&&(f.fittingRules[y]=b[y])}return f.printDirection=typeof g.printDirection<"u"?g.printDirection:m.printDirection,f.showHardBlanks=g.showHardBlanks||!1,f.width=g.width||-1,f.whitespaceBreak=g.whitespaceBreak||!1,f}const Y=function(m,g,f){return Y.text(m,g,f)};return Y.text=async function(m,g,f){let b="";return m=m+"",typeof arguments[1]=="function"&&(f=g,g={},g.font=c.font),typeof g=="string"?(b=g,g={}):(g=g||{},b=g.font||c.font),await new Promise((y,k)=>{Y.loadFont(b,function(A,D){if(A){k(A),f&&f(A);return}const C=ot(b,ct(D,g),m);y(C),f&&f(null,C)})})},Y.textSync=function(m,g){let f="";m=m+"",typeof g=="string"?(f=g,g={}):(g=g||{},f=g.font||c.font);var b=ct(Y.loadFontSync(f),g);return ot(f,b,m)},Y.metadata=function(m,g){m=m+"",Y.loadFont(m,function(f,b){if(f){g(f);return}g(null,b,o[m].comment)})},Y.defaults=function(m){if(typeof m=="object"&&m!==null)for(var g in m)m.hasOwnProperty(g)&&(c[g]=m[g]);return JSON.parse(JSON.stringify(c))},Y.parseFont=function(m,g){g=g.replace(/\r\n/g,`
`).replace(/\r/g,`
`),o[m]={};var f=g.split(`
...
`),y.numChars=0;f.length>0&&y.numChars<A.length;){for(C=A[y.numChars],y[C]=f.splice(0,k.height),D=0;D<k.height;D++)typeof y[C][D]>"u"?y[C][D]="":(S=new RegExp("\\"+y[C][D].substr(y[C][D].length-1,1)+"+$"),y[C][D]=y[C][D].replace(S,""));y.numChars++}for(;f.length>0;){if(C=f.splice(0,1)[0].split(" ")[0],/^0[xX][0-9a-fA-F]+$/.test(C))C=parseInt(C,16);else if(/^0[0-7]+$/.test(C))C=parseInt(C,8);else if(/^[0-9]+$/.test(C))C=parseInt(C,10);else if(/^-0[xX][0-9a-fA-F]+$/.test(C))C=parseInt(C,16);else{if(C==="")break;console.log("Invalid data:"+C),H=!0;break}for(y[C]=f.splice(0,k.height),D=0;D<k.height;D++)typeof y[C][D]>"u"?y[C][D]="":(S=new RegExp("\\"+y[C][D].substr(y[C][D].length-1,1)+"+$"),y[C][D]=y[C][D].replace(S,""));y.numChars++}if(H===!0)throw new Error("Error parsing data.");return k},Y.loadFont=function(m,g){if(o[m]){g(null,o[m].options);return}if(typeof fetch!="function")throw console.error("figlet.js requires the fetch API or a fetch polyfill such as https://cdnjs.com/libraries/fetch"),new Error("fetch is required for figlet.js to work.");fetch(c.fontPath+"/"+m+".flf").then(function(f){if(f.ok)return f.text();throw console.log("Unexpected response",f),new Error("Network response was not ok.")}).then(function(f){g(null,Y.parseFont(m,f))}).catch(g)},Y.loadFontSync=function(m){if(o[m])return o[m].options;throw new Error("synchronous font loading is not implemented for the browser")},Y.preloadFonts=function(m,g){let f=[];m.reduce(function(b,y){return b.then(function(){return fetch(c.fontPath+"/"+y+".flf").then(k=>k.text()).then(function(k){f.push(k)})})},Promise.resolve()).then(function(b){for(var y in m)m.hasOwnProperty(y)&&Y.parseFont(m[y],f[y]);g&&g()})},Y.figFonts=o,Y})();u.exports=e})(Zn);var us=Zn.exports;const Ht=Yc(us),es=`flf2a$ 11 8 35 -1 14
...
Enter 'theme ${e[0]}' to see all available options.`])])}},ns=async()=>{const u=await $fetch("/api/getRuntimeConfig").catch(e=>ku(()=>import("./config.DY70oKIP.js"),__vite__mapDeps([]),import.meta.url));return p($,null,[p("div",{className:"flex flex-col items-start"},["fetchsum: summary display",p("div",{className:"flex flex-row flex-wrap sm:flex-nowrap max-w-full"},[p("div",{className:"whitespace-pre-wrap m-auto sm:mx-0 flex-grow-1",style:{}},[p("pre",{className:" leading-[normal]",style:{fontSize:"max(0.1rem, 2.5vmin)",lineHeight:"normal"}},[`
    ...
    |_____________________________|/
     ...
     //̅-/̅-/̅-/̅-/̅-/̅-/̅-/̅-/̅-/̅- //
    / /̅-/̅-/̅-/̅-/̅-/̅-/̅-/̅-/̅-/̅-//
    ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾`])]),p("div",{className:"whitespace-pre-wrap w-full mx-auto md:mx-0 my-4 sm:my-auto flex-grow-1"},[p("ul",{className:""},[p("li",{className:"min-w-full border-y-light-foreground : dark:border-y-dark-foreground border-solid border-y-2 py-2 my-4 list-none"},[gu(" ABOUT")]),p("li",{className:"pl-4"},[u.NAME]),p("li",{className:"pl-4"},[p("u",null,[p("a",{href:`${u.RESUME}`,target:"_blank"},[gu("Resume")])])]),p("li",{className:"pl-4"},[p("u",null,[p("a",{href:`${u.GITHUB_REPO}`,target:"_blank"},[gu("GitHub Repo")])])]),p("li",{className:"min-w-full border-y-light-foreground : dark:border-y-dark-foreground border-solid border-y-2 py-2 my-4 list-none"},[gu(" CONTACT")]),p("li",{className:"pl-4"},[p("u",null,[p("a",{href:`mailto:${u.EMAIL}`,target:"_blank"},[u.EMAIL])])]),p("li",{className:"pl-4"},[p("u",null,[p("a",{href:`https://github.com/${u.GITHUB}`,target:"_blank"},[gu("github.com/"),u.GITHUB])])]),p("li",{className:"pl-4"},[p("u",null,[p("a",{href:`https://linkedin.com/in/${u.LINKEDIN}`,target:"_blank"},[gu("linkedin.com/in/"),u.LINKEDIN])])])])])])])])},Wt=u=>["clear",...Object.keys(ju)].indexOf(u==null?void 0:u.split(" ")[0].toLowerCase())!==-1,rs=async(u,e,t,n)=>{const r=u.split(" ");if(r[0]=r[0].toLowerCase(),r[0]==="clear")t();else if(u==="")e("");else if(Object.keys(ju).indexOf(r[0])===-1)e(p($,null,[p("span",null,[`
shell: command not found: ${r[0]}. 

Try 'help' to get started.`])]));else{const i=await ju[r[0]](r.slice(1));e(i)}n("")},is=(u,e)=>{const t=Object.keys(ju).filter(n=>n.startsWith(u));t.length===1&&e(t[0])},os={class:"flex flex-row items-start min-w-full"},cs=["onKeydown"],ss={__name:"TerminalInput",props:or({containerRef:{type:Object},setCommand:{type:Function},setHistory:{type:Function},clearHistory:{type:Function},setLastCommandIndex:{type:Function}},{input:{},inputModifiers:{}}),emits:["update:input"],setup(u,{expose:e}){const t=u,{containerRef:n,setCommand:r,setHistory:i,clearHistory:o,setLastCommandIndex:c}=t,s=nu("history"),a=nu("command"),d=nu("lastCommandIndex"),[l,x]=cr(u,"input"),_=K(),h=K(),w=K(),R=K();K(!1);const B=K(0),O=K(Wt(l.value)),F=Qt(()=>({"text-light-green dark:text-dark-green":O.value,"text-light-foreground dark:text-dark-foreground":!O.value||a.value===""})),T=()=>{B.value++},v=L=>{L.style.removeProperty("height"),L.style.padding="0px",L.style.height=L.scrollHeight+"px",L.style.removeProperty("padding")},M=(L,I)=>{const N=L.offsetWidth<=I.offsetWidth+I.offsetLeft+10;L.style.left=-L.offsetWidth+"px",L.style.textIndent=N?"0px":I.offsetWidth+I.offsetLeft+5+"px",L.style.marginTop=N?I.offsetTop+I.offsetHeight+"px":I.offsetTop+"px"};let V;Ue(()=>{if(V=new ResizeObserver(L=>{L.forEach(async I=>{if(_.value){const N=_.value,vu=h.value,ke=R.value.endRef||vu.children[0].children[3];v(N),M(N,ke)}})}),_.value){const L=_.value,I=h.value,N=R.value.endRef||I.children[0].children[3];v(L),M(L,N)}w.value&&V.observe(w.value)}),He(()=>{if(O.value=Wt(l.value),w.value&&V.observe(w.value),n.scrollTo(0,n.scrollHeight),_.value){const L=_.value,I=h.value,N=R.value.endRef||I.children[0].children[3];v(L),M(L,N)}});const su=L=>{const{target:I}=L;v(I),r(l.value)},au=async L=>{l.value&&((L.key==="Enter"||L.keyCode===13)&&(c(0),await rs(a.value,i,o,r),n.scrollTo(0,n.scrollHeight)),l.value=a.value)},Tu=async L=>{L.key==="c"&&(r(""),i(""),c(0)),L.key==="l"&&o(),l.value=a.value,T()},$u=L=>{L.key==="Tab"&&is(a.value,r),l.value=a.value,T()},Eu=L=>{const I=s.value.map(({command:N})=>N).filter(N=>N);if(L.key==="ArrowUp"){if(!I.length)return;const N=d.value+1;N<=I.length&&(c(N),r(I[I.length-N]))}if(L.key==="ArrowDown"){if(!I.length)return;const N=d.value-1;N>0?(c(N),r(I[I.length-N])):(c(0),r(""))}l.value=a.value};return e({inputRef:_}),(L,I)=>{const N=en;return fu(),Su("div",{key:du(B),id:"terminal-input",ref_key:"commandRef",ref:w},[uu("section",os,[uu("label",{ref_key:"labelRef",ref:h,for:"command-input",class:"flex-shrink flex-1 z-10 relative min-w-full break-words text-wrap"},[p(N,{ref_key:"endRef",ref:R},null,512)],512),sr(uu("textarea",{ref_key:"inputRef",ref:_,id:"command-input",type:"text",class:lr(["flex-1 bg-light-background dark:bg-dark-background relative flex-grow min-w-full mr-1 focus:outline-none resize-none break-words text-wrap",du(F)]),"onUpdate:modelValue":I[0]||(I[0]=vu=>Zt(l)?l.value=vu:null),onKeydown:[Ou(Ru(Tu,["ctrl","prevent"]),["c"]),Ou(Ru(Tu,["ctrl","prevent"]),["l"]),Ou(Ru($u,["prevent"]),["tab"]),Ou(Ru(au,["prevent"]),["enter"]),Ou(Ru(Eu,["prevent"]),["up"]),Ou(Ru(Eu,["prevent"]),["down"])],onInput:Ru(su,["prevent"]),autofocus:"",autocomplete:"off",spellcheck:"false"},`
      `,42,cs),[[ar,du(l),void 0,{trim:!0}]])])])}}},as=ss,ls=(u=[])=>{const e=nu("history",()=>u),t=nu("command",()=>""),n=nu("lastCommandIndex",()=>0);return fr({history:e,command:t,lastCommandIndex:n,setHistory:s=>{const a=nu("history"),d=nu("command");a.value.push({id:a.value.length,date:new Date,command:d.value,output:s})},clearHistory:()=>{const s=nu("history");s.value.length=0},setCommand:s=>{const a=nu("command");a.value=s},setLastCommandIndex:s=>{const a=nu("lastCommandIndex");a.value=s}})},fs={class:"w-full h-full bg-light-background dark:bg-dark-background p-1 sm:p2"},ds={class:"max-w-full xl:max-w-4xl"},ps={__name:"index",setup(u){const e=Qt(()=>it("theme",{default:()=>"default",watch:"shallow"}));dr({htmlAttrs:{class:e.value}});const t=K(),n=K(0),r=K(),i=nu("history"),{setCommand:o,setHistory:c,setLastCommandIndex:s,clearHistory:a}=ls([]),d=()=>{n.value+=1};Ue(async()=>{var x;((x=i.value)==null?void 0:x.length)===0&&(c(await Jn()),d()),r.value.offsetHeight<=r.value.scrollHeight?(r.value.style.paddingRight="20px",r.value.scrollTo(0,r.value.scrollHeight)):r.value.style.paddingRight&&r.value.style.removeProperty("paddingRight")}),He(()=>{r.value.offsetHeight<=r.value.scrollHeight?(r.value.style.paddingRight="10px",r.value.scrollTo(0,r.value.scrollHeight)):r.value.style.paddingRight&&r.value.style.removeProperty("paddingRight")}),Jt(()=>{n.value>0&&(n.value=0)});const l=x=>{hr(()=>{var _;(_=t.value)!=null&&_.inputRef&&t.value.inputRef.focus()})};return(x,_)=>{const h=Tr,w=as;return fu(),Su("main",fs,[uu("div",{class:"h-full border-2 rounded border-light-yellow dark:border-dark-yellow overflow-hidden p-2 sm:p-3 md:p-5",onClick:l},[uu("div",{ref_key:"containerRef",ref:r,class:"h-full scrollbar-thin scrollbar-webkit overflow-y-auto overflow-x-hidden"},[uu("div",ds,[(fu(),Le(h,{key:n.value})),r.value?(fu(),Le(w,{ref_key:"inputRef",ref:t,key:n.value,containerRef:r.value,setHistory:du(c),clearHistory:du(a),setCommand:du(o),setLastCommandIndex:du(s)},null,8,["containerRef","setHistory","clearHistory","setCommand","setLastCommandIndex"])):re("",!0)])],512)])])}}};export{ps as default};
